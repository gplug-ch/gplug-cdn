(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))r(i);new MutationObserver(i=>{for(const a of i)if(a.type==="childList")for(const o of a.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&r(o)}).observe(document,{childList:!0,subtree:!0});function n(i){const a={};return i.integrity&&(a.integrity=i.integrity),i.referrerPolicy&&(a.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?a.credentials="include":i.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function r(i){if(i.ep)return;i.ep=!0;const a=n(i);fetch(i.href,a)}})();var qt,Y,Kr,Te,Zn,jr,zr,nn,Tt,ct,qr,Cn,cn,fn,Wt={},Ht=[],ea=/acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i,Yt=Array.isArray;function xe(e,t){for(var n in t)e[n]=t[n];return e}function Mn(e){e&&e.parentNode&&e.parentNode.removeChild(e)}function Yr(e,t,n){var r,i,a,o={};for(a in t)a=="key"?r=t[a]:a=="ref"?i=t[a]:o[a]=t[a];if(arguments.length>2&&(o.children=arguments.length>3?qt.call(arguments,2):n),typeof e=="function"&&e.defaultProps!=null)for(a in e.defaultProps)o[a]===void 0&&(o[a]=e.defaultProps[a]);return It(e,o,r,i,null)}function It(e,t,n,r,i){var a={type:e,props:t,key:n,ref:r,__k:null,__:null,__b:0,__e:null,__c:null,constructor:void 0,__v:i??++Kr,__i:-1,__u:0};return i==null&&Y.vnode!=null&&Y.vnode(a),a}function _t(e){return e.children}function Pt(e,t){this.props=e,this.context=t}function Ve(e,t){if(t==null)return e.__?Ve(e.__,e.__i+1):null;for(var n;t<e.__k.length;t++)if((n=e.__k[t])!=null&&n.__e!=null)return n.__e;return typeof e.type=="function"?Ve(e):null}function ta(e){if(e.__P&&e.__d){var t=e.__v,n=t.__e,r=[],i=[],a=xe({},t);a.__v=t.__v+1,Y.vnode&&Y.vnode(a),Nn(e.__P,a,t,e.__n,e.__P.namespaceURI,32&t.__u?[n]:null,r,n??Ve(t),!!(32&t.__u),i),a.__v=t.__v,a.__.__k[a.__i]=a,Jr(r,a,i),t.__e=t.__=null,a.__e!=n&&Vr(a)}}function Vr(e){if((e=e.__)!=null&&e.__c!=null)return e.__e=e.__c.base=null,e.__k.some(function(t){if(t!=null&&t.__e!=null)return e.__e=e.__c.base=t.__e}),Vr(e)}function Xn(e){(!e.__d&&(e.__d=!0)&&Te.push(e)&&!Kt.__r++||Zn!=Y.debounceRendering)&&((Zn=Y.debounceRendering)||jr)(Kt)}function Kt(){try{for(var e,t=1;Te.length;)Te.length>t&&Te.sort(zr),e=Te.shift(),t=Te.length,ta(e)}finally{Te.length=Kt.__r=0}}function Gr(e,t,n,r,i,a,o,l,f,d,p){var v,c,h,g,b,_,C,$=r&&r.__k||Ht,L=t.length;for(f=na(n,t,$,f,L),v=0;v<L;v++)(h=n.__k[v])!=null&&(c=h.__i!=-1&&$[h.__i]||Wt,h.__i=v,_=Nn(e,h,c,i,a,o,l,f,d,p),g=h.__e,h.ref&&c.ref!=h.ref&&(c.ref&&En(c.ref,null,h),p.push(h.ref,h.__c||g,h)),b==null&&g!=null&&(b=g),(C=!!(4&h.__u))||c.__k===h.__k?(f=Zr(h,f,e,C),C&&c.__e&&(c.__e=null)):typeof h.type=="function"&&_!==void 0?f=_:g&&(f=g.nextSibling),h.__u&=-7);return n.__e=b,f}function na(e,t,n,r,i){var a,o,l,f,d,p=n.length,v=p,c=0;for(e.__k=new Array(i),a=0;a<i;a++)(o=t[a])!=null&&typeof o!="boolean"&&typeof o!="function"?(typeof o=="string"||typeof o=="number"||typeof o=="bigint"||o.constructor==String?o=e.__k[a]=It(null,o,null,null,null):Yt(o)?o=e.__k[a]=It(_t,{children:o},null,null,null):o.constructor===void 0&&o.__b>0?o=e.__k[a]=It(o.type,o.props,o.key,o.ref?o.ref:null,o.__v):e.__k[a]=o,f=a+c,o.__=e,o.__b=e.__b+1,l=null,(d=o.__i=ra(o,n,f,v))!=-1&&(v--,(l=n[d])&&(l.__u|=2)),l==null||l.__v==null?(d==-1&&(i>p?c--:i<p&&c++),typeof o.type!="function"&&(o.__u|=4)):d!=f&&(d==f-1?c--:d==f+1?c++:(d>f?c--:c++,o.__u|=4))):e.__k[a]=null;if(v)for(a=0;a<p;a++)(l=n[a])!=null&&(2&l.__u)==0&&(l.__e==r&&(r=Ve(l)),ei(l,l));return r}function Zr(e,t,n,r){var i,a;if(typeof e.type=="function"){for(i=e.__k,a=0;i&&a<i.length;a++)i[a]&&(i[a].__=e,t=Zr(i[a],t,n,r));return t}e.__e!=t&&(r&&(t&&e.type&&!t.parentNode&&(t=Ve(e)),n.insertBefore(e.__e,t||null)),t=e.__e);do t=t&&t.nextSibling;while(t!=null&&t.nodeType==8);return t}function ra(e,t,n,r){var i,a,o,l=e.key,f=e.type,d=t[n],p=d!=null&&(2&d.__u)==0;if(d===null&&l==null||p&&l==d.key&&f==d.type)return n;if(r>(p?1:0)){for(i=n-1,a=n+1;i>=0||a<t.length;)if((d=t[o=i>=0?i--:a++])!=null&&(2&d.__u)==0&&l==d.key&&f==d.type)return o}return-1}function Jn(e,t,n){t[0]=="-"?e.setProperty(t,n??""):e[t]=n==null?"":typeof n!="number"||ea.test(t)?n:n+"px"}function wt(e,t,n,r,i){var a,o;e:if(t=="style")if(typeof n=="string")e.style.cssText=n;else{if(typeof r=="string"&&(e.style.cssText=r=""),r)for(t in r)n&&t in n||Jn(e.style,t,"");if(n)for(t in n)r&&n[t]==r[t]||Jn(e.style,t,n[t])}else if(t[0]=="o"&&t[1]=="n")a=t!=(t=t.replace(qr,"$1")),o=t.toLowerCase(),t=o in e||t=="onFocusOut"||t=="onFocusIn"?o.slice(2):t.slice(2),e.l||(e.l={}),e.l[t+a]=n,n?r?n[ct]=r[ct]:(n[ct]=Cn,e.addEventListener(t,a?fn:cn,a)):e.removeEventListener(t,a?fn:cn,a);else{if(i=="http://www.w3.org/2000/svg")t=t.replace(/xlink(H|:h)/,"h").replace(/sName$/,"s");else if(t!="width"&&t!="height"&&t!="href"&&t!="list"&&t!="form"&&t!="tabIndex"&&t!="download"&&t!="rowSpan"&&t!="colSpan"&&t!="role"&&t!="popover"&&t in e)try{e[t]=n??"";break e}catch{}typeof n=="function"||(n==null||n===!1&&t[4]!="-"?e.removeAttribute(t):e.setAttribute(t,t=="popover"&&n==1?"":n))}}function Qn(e){return function(t){if(this.l){var n=this.l[t.type+e];if(t[Tt]==null)t[Tt]=Cn++;else if(t[Tt]<n[ct])return;return n(Y.event?Y.event(t):t)}}}function Nn(e,t,n,r,i,a,o,l,f,d){var p,v,c,h,g,b,_,C,$,L,F,M,w,z,P,A,y=t.type;if(t.constructor!==void 0)return null;128&n.__u&&(f=!!(32&n.__u),a=[l=t.__e=n.__e]),(p=Y.__b)&&p(t);e:if(typeof y=="function"){v=o.length;try{if($=t.props,L=y.prototype&&y.prototype.render,F=(p=y.contextType)&&r[p.__c],M=p?F?F.props.value:p.__:r,n.__c?C=(c=t.__c=n.__c).__=c.__E:(L?t.__c=c=new y($,M):(t.__c=c=new Pt($,M),c.constructor=y,c.render=aa),F&&F.sub(c),c.state||(c.state={}),c.__n=r,h=c.__d=!0,c.__h=[],c._sb=[]),L&&c.__s==null&&(c.__s=c.state),L&&y.getDerivedStateFromProps!=null&&(c.__s==c.state&&(c.__s=xe({},c.__s)),xe(c.__s,y.getDerivedStateFromProps($,c.__s))),g=c.props,b=c.state,c.__v=t,h)L&&y.getDerivedStateFromProps==null&&c.componentWillMount!=null&&c.componentWillMount(),L&&c.componentDidMount!=null&&c.__h.push(c.componentDidMount);else{if(L&&y.getDerivedStateFromProps==null&&$!==g&&c.componentWillReceiveProps!=null&&c.componentWillReceiveProps($,M),t.__v==n.__v||!c.__e&&c.shouldComponentUpdate!=null&&c.shouldComponentUpdate($,c.__s,M)===!1){t.__v!=n.__v&&(c.props=$,c.state=c.__s,c.__d=!1),t.__e=n.__e,t.__k=n.__k,t.__k.some(function(O){O&&(O.__=t)}),Ht.push.apply(c.__h,c._sb),c._sb=[],c.__h.length&&o.push(c);break e}c.componentWillUpdate!=null&&c.componentWillUpdate($,c.__s,M),L&&c.componentDidUpdate!=null&&c.__h.push(function(){c.componentDidUpdate(g,b,_)})}if(c.context=M,c.props=$,c.__P=e,c.__e=!1,w=Y.__r,z=0,L)c.state=c.__s,c.__d=!1,w&&w(t),p=c.render(c.props,c.state,c.context),Ht.push.apply(c.__h,c._sb),c._sb=[];else do c.__d=!1,w&&w(t),p=c.render(c.props,c.state,c.context),c.state=c.__s;while(c.__d&&++z<25);c.state=c.__s,c.getChildContext!=null&&(r=xe(xe({},r),c.getChildContext())),L&&!h&&c.getSnapshotBeforeUpdate!=null&&(_=c.getSnapshotBeforeUpdate(g,b)),P=p!=null&&p.type===_t&&p.key==null?Qr(p.props.children):p,l=Gr(e,Yt(P)?P:[P],t,n,r,i,a,o,l,f,d),c.base=t.__e,t.__u&=-161,c.__h.length&&o.push(c),C&&(c.__E=c.__=null)}catch(O){if(o.length=v,t.__v=null,f||a!=null){if(O.then){for(t.__u|=f?160:128;l&&l.nodeType==8&&l.nextSibling;)l=l.nextSibling;a!=null&&(a[a.indexOf(l)]=null),t.__e=l}else if(a!=null)for(A=a.length;A--;)Mn(a[A])}else t.__e=n.__e;t.__k==null&&(t.__k=n.__k||[]),O.then||Xr(t),Y.__e(O,t,n)}}else a==null&&t.__v==n.__v?(t.__k=n.__k,t.__e=n.__e):l=t.__e=ia(n.__e,t,n,r,i,a,o,f,d);return(p=Y.diffed)&&p(t),128&t.__u?void 0:l}function Xr(e){e&&(e.__c&&(e.__c.__e=!0),e.__k&&e.__k.some(Xr))}function Jr(e,t,n){for(var r=0;r<n.length;r++)En(n[r],n[++r],n[++r]);Y.__c&&Y.__c(t,e),e.some(function(i){try{e=i.__h,i.__h=[],e.some(function(a){a.call(i)})}catch(a){Y.__e(a,i.__v)}})}function Qr(e){return typeof e!="object"||e==null||e.__b>0?e:Yt(e)?e.map(Qr):e.constructor!==void 0?null:xe({},e)}function ia(e,t,n,r,i,a,o,l,f){var d,p,v,c,h,g,b,_=n.props||Wt,C=t.props,$=t.type;if($=="svg"?i="http://www.w3.org/2000/svg":$=="math"?i="http://www.w3.org/1998/Math/MathML":i||(i="http://www.w3.org/1999/xhtml"),a!=null){for(d=0;d<a.length;d++)if((h=a[d])&&"setAttribute"in h==!!$&&($?h.localName==$:h.nodeType==3)){e=h,a[d]=null;break}}if(e==null){if($==null)return document.createTextNode(C);e=document.createElementNS(i,$,C.is&&C),l&&(Y.__m&&Y.__m(t,a),l=!1),a=null}if($==null)_===C||l&&e.data==C||(e.data=C);else{if(a=$=="textarea"&&C.defaultValue!=null?null:a&&qt.call(e.childNodes),!l&&a!=null)for(_={},d=0;d<e.attributes.length;d++)_[(h=e.attributes[d]).name]=h.value;for(d in _)h=_[d],d=="dangerouslySetInnerHTML"?v=h:d=="children"||d in C||d=="value"&&"defaultValue"in C||d=="checked"&&"defaultChecked"in C||wt(e,d,null,h,i);for(d in C)h=C[d],d=="children"?c=h:d=="dangerouslySetInnerHTML"?p=h:d=="value"?g=h:d=="checked"?b=h:l&&typeof h!="function"||_[d]===h||wt(e,d,h,_[d],i);if(p)l||v&&(p.__html==v.__html||p.__html==e.innerHTML)||(e.innerHTML=p.__html),t.__k=[];else if(v&&(e.innerHTML=""),Gr(t.type=="template"?e.content:e,Yt(c)?c:[c],t,n,r,$=="foreignObject"?"http://www.w3.org/1999/xhtml":i,a,o,a?a[0]:n.__k&&Ve(n,0),l,f),a!=null)for(d=a.length;d--;)Mn(a[d]);l&&$!="textarea"||(d="value",$=="progress"&&g==null?e.removeAttribute("value"):g!=null&&(g!==e[d]||$=="progress"&&!g||$=="option"&&g!=_[d])&&wt(e,d,g,_[d],i),d="checked",b!=null&&b!=e[d]&&wt(e,d,b,_[d],i))}return e}function En(e,t,n){try{if(typeof e=="function"){var r=typeof e.__u=="function";r&&e.__u(),r&&t==null||(e.__u=e(t))}else e.current=t}catch(i){Y.__e(i,n)}}function ei(e,t,n){var r,i;if(Y.unmount&&Y.unmount(e),(r=e.ref)&&(r.current&&r.current!=e.__e||En(r,null,t)),(r=e.__c)!=null){if(r.componentWillUnmount)try{r.componentWillUnmount()}catch(a){Y.__e(a,t)}r.base=r.__P=r.__n=null}if(r=e.__k)for(i=0;i<r.length;i++)r[i]&&ei(r[i],t,n||typeof e.type!="function");n||Mn(e.__e),e.__c=e.__=e.__e=void 0}function aa(e,t,n){return this.constructor(e,n)}function sa(e,t,n){var r,i,a,o;t==document&&(t=document.documentElement),Y.__&&Y.__(e,t),i=(r=!1)?null:t.__k,a=[],o=[],Nn(t,e=t.__k=Yr(_t,null,[e]),i||Wt,Wt,t.namespaceURI,i?null:t.firstChild?qt.call(t.childNodes):null,a,i?i.__e:t.firstChild,r,o),Jr(a,e,o),e.props.children=null}qt=Ht.slice,Y={__e:function(e,t,n,r){for(var i,a,o;t=t.__;)if((i=t.__c)&&!i.__)try{if((a=i.constructor)&&a.getDerivedStateFromError!=null&&(i.setState(a.getDerivedStateFromError(e)),o=i.__d),i.componentDidCatch!=null&&(i.componentDidCatch(e,r||{}),o=i.__d),o)return i.__E=i}catch(l){e=l}throw e}},Kr=0,Pt.prototype.setState=function(e,t){var n;n=this.__s!=null&&this.__s!=this.state?this.__s:this.__s=xe({},this.state),typeof e=="function"&&(e=e(xe({},n),this.props)),e&&xe(n,e),e!=null&&this.__v&&(t&&this._sb.push(t),Xn(this))},Pt.prototype.forceUpdate=function(e){this.__v&&(this.__e=!0,e&&this.__h.push(e),Xn(this))},Pt.prototype.render=_t,Te=[],jr=typeof Promise=="function"?Promise.prototype.then.bind(Promise.resolve()):setTimeout,zr=function(e,t){return e.__v.__b-t.__v.__b},Kt.__r=0,nn=Math.random().toString(8),Tt="__d"+nn,ct="__a"+nn,qr=/(PointerCapture)$|Capture$/i,Cn=0,cn=Qn(!1),fn=Qn(!0);var vt,Z,rn,er,jt=0,ti=[],ee=Y,tr=ee.__b,nr=ee.__r,rr=ee.diffed,ir=ee.__c,ar=ee.unmount,sr=ee.__;function Tn(e,t){ee.__h&&ee.__h(Z,e,jt||t),jt=0;var n=Z.__H||(Z.__H={__:[],__h:[]});return e>=n.__.length&&n.__.push({}),n.__[e]}function I(e){return jt=1,oa(ri,e)}function oa(e,t,n){var r=Tn(vt++,2);if(r.t=e,!r.__c&&(r.__=[ri(void 0,t),function(l){var f=r.__N?r.__N[0]:r.__[0],d=r.t(f,l);f!==d&&(r.__N=[d,r.__[1]],r.__c.setState({}))}],r.__c=Z,!Z.__f)){var i=function(l,f,d){if(!r.__c.__H)return!0;var p=!1,v=r.__c.props!==l;if(r.__c.__H.__.some(function(h){if(h.__N){p=!0;var g=h.__[0];h.__=h.__N,h.__N=void 0,g!==h.__[0]&&(v=!0)}}),a){var c=a.call(this,l,f,d);return p?c||v:c}return!p||v};Z.__f=!0;var a=Z.shouldComponentUpdate,o=Z.componentWillUpdate;Z.componentWillUpdate=function(l,f,d){if(this.__e){var p=a;a=void 0,i(l,f,d),a=p}o&&o.call(this,l,f,d)},Z.shouldComponentUpdate=i}return r.__N||r.__}function X(e,t){var n=Tn(vt++,3);!ee.__s&&ni(n.__H,t)&&(n.__=e,n.u=t,Z.__H.__h.push(n))}function Ce(e){return jt=5,Le(function(){return{current:e}},[])}function Le(e,t){var n=Tn(vt++,7);return ni(n.__H,t)&&(n.__=e(),n.__H=t,n.__h=e),n.__}function la(){for(var e;e=ti.shift();){var t=e.__H;if(e.__P&&t)try{t.__h.some(Ot),t.__h.some(dn),t.__h=[]}catch(n){t.__h=[],ee.__e(n,e.__v)}}}ee.__b=function(e){Z=null,tr&&tr(e)},ee.__=function(e,t){e&&t.__k&&t.__k.__m&&(e.__m=t.__k.__m),sr&&sr(e,t)},ee.__r=function(e){nr&&nr(e),vt=0;var t=(Z=e.__c).__H;t&&(rn===Z?(t.__h=[],Z.__h=[],t.__.some(function(n){n.__N&&(n.__=n.__N),n.u=n.__N=void 0})):(t.__h.some(Ot),t.__h.some(dn),t.__h=[],vt=0)),rn=Z},ee.diffed=function(e){rr&&rr(e);var t=e.__c;t&&t.__H&&(t.__H.__h.length&&(ti.push(t)!==1&&er===ee.requestAnimationFrame||((er=ee.requestAnimationFrame)||ua)(la)),t.__H.__.some(function(n){n.u&&(n.__H=n.u,n.u=void 0)})),rn=Z=null},ee.__c=function(e,t){t.some(function(n){try{n.__h.some(Ot),n.__h=n.__h.filter(function(r){return!r.__||dn(r)})}catch(r){t.some(function(i){i.__h&&(i.__h=[])}),t=[],ee.__e(r,n.__v)}}),ir&&ir(e,t)},ee.unmount=function(e){ar&&ar(e);var t,n=e.__c;n&&n.__H&&(n.__H.__.some(function(r){try{Ot(r)}catch(i){t=i}}),n.__H=void 0,t&&ee.__e(t,n.__v))};var or=typeof requestAnimationFrame=="function";function ua(e){var t,n=function(){clearTimeout(r),or&&cancelAnimationFrame(t),setTimeout(e)},r=setTimeout(n,35);or&&(t=requestAnimationFrame(n))}function Ot(e){var t=Z,n=e.__c;typeof n=="function"&&(e.__c=void 0,n()),Z=t}function dn(e){var t=Z;e.__c=e.__(),Z=t}function ni(e,t){return!e||e.length!==t.length||t.some(function(n,r){return n!==e[r]})}function ri(e,t){return typeof t=="function"?t(e):t}var ii=function(e,t,n,r){var i;t[0]=0;for(var a=1;a<t.length;a++){var o=t[a++],l=t[a]?(t[0]|=o?1:2,n[t[a++]]):t[++a];o===3?r[0]=l:o===4?r[1]=Object.assign(r[1]||{},l):o===5?(r[1]=r[1]||{})[t[++a]]=l:o===6?r[1][t[++a]]+=l+"":o?(i=e.apply(l,ii(e,l,n,["",null])),r.push(i),l[0]?t[0]|=2:(t[a-2]=0,t[a]=i)):r.push(l)}return r},lr=new Map;function ca(e){var t=lr.get(this);return t||(t=new Map,lr.set(this,t)),(t=ii(this,t.get(e)||(t.set(e,t=(function(n){for(var r,i,a=1,o="",l="",f=[0],d=function(c){a===1&&(c||(o=o.replace(/^\s*\n\s*|\s*\n\s*$/g,"")))?f.push(0,c,o):a===3&&(c||o)?(f.push(3,c,o),a=2):a===2&&o==="..."&&c?f.push(4,c,0):a===2&&o&&!c?f.push(5,0,!0,o):a>=5&&((o||!c&&a===5)&&(f.push(a,0,o,i),a=6),c&&(f.push(a,c,0,i),a=6)),o=""},p=0;p<n.length;p++){p&&(a===1&&d(),d(p));for(var v=0;v<n[p].length;v++)r=n[p][v],a===1?r==="<"?(d(),f=[f],a=3):o+=r:a===4?o==="--"&&r===">"?(a=1,o=""):o=r+o[0]:l?r===l?l="":o+=r:r==='"'||r==="'"?l=r:r===">"?(d(),a=1):a&&(r==="="?(a=5,i=o,o=""):r==="/"&&(a<5||n[p][v+1]===">")?(d(),a===3&&(f=f[0]),a=f,(f=f[0]).push(2,0,a),a=0):r===" "||r==="	"||r===`
`||r==="\r"?(d(),a=2):o+=r),a===3&&o==="!--"&&(a=4,f=f[0])}return d(),f})(e)),t),arguments,[])).length>1?t:t[0]}const u=ca.bind(Yr);var ft={},ai="de",ur={};function s(e,t){var n=ft[e];return n===void 0?(ur[e]||(ur[e]=!0,console.warn('i18n: missing key "'+e+'"')),e):(t&&(n=n.replace(/\{(\w+)\}/g,function(r,i){return t[i]!==void 0?String(t[i]):r})),n)}function fa(e){var t=0;function n(){if(t>=e.length)return Promise.reject(new Error("i18n: no language file reachable"));var r=e[t++];return fetch(r).then(function(i){if(!i.ok)throw new Error("HTTP "+i.status);return i.json()}).then(function(i){return ft=i||{},ai=ft["meta.lang"]||document.documentElement.lang||"de",ft}).catch(function(){return n()})}return n()}const da={t:s,load:fa,getLang:function(){return ai},getDict:function(){return ft}};var ht=" ",si="−";function Ge(e,t){if(e==null||isNaN(e))return"–";var n=e<0,r=Math.abs(Number(e)).toFixed(t),i=r.split(".");return i[0]=i[0].replace(/\B(?=(\d{3})+(?!\d))/g,"'"),r=i.join("."),(n?si:"")+r}function pa(e){return e.indexOf(".")>=0?e.replace(/\.?0+$/,""):e}function va(e){return e==null||isNaN(e)?"–":Math.abs(e)>=1e3?pa(Ge(e/1e3,1))+ht+"kW":Ge(Math.round(e),0)+ht+"W"}function ha(e){return e==null||isNaN(e)?"–":Math.abs(e)>=1e3?Ge(e/1e3,2)+ht+"kWh":Ge(Math.round(e),0)+ht+"Wh"}function ga(e,t){if(e==null||isNaN(e))return"–";var n=Ge(e,2);return t&&e>0&&(n="+"+n),n+ht+"CHF"}function Oe(e){return(e<10?"0":"")+e}function ma(e,t){if(e==null)return"–";var n=new Date(e*1e3),r=Oe(n.getDate())+"."+Oe(n.getMonth()+1)+"."+n.getFullYear(),i=Oe(n.getHours())+":"+Oe(n.getMinutes());switch(t){case"1d":return r;case"dm":return Oe(n.getDate())+"."+Oe(n.getMonth()+1)+".";case"1mo":return Oe(n.getMonth()+1)+"."+n.getFullYear();case"q":return n.getFullYear()+" Q"+(Math.floor(n.getMonth()/3)+1);case"hm":return i;case"15m":default:return r+" "+i}}const k={num:Ge,w:va,wh:ha,chf:ga,time:ma,MINUS:si};function Ze(e){return u`
      ...
      </label>`}function _e(e){var t=I(!1),n=t[0],r=t[1],i=I(null),a=i[0],o=i[1],l=Ce(null),f=Ce(null);return X(function(){if(!n)return;function d($){$.key==="Escape"&&r(!1)}function p($){f.current&&!f.current.contains($.target)&&r(!1)}document.addEventListener("keydown",d),document.addEventListener("click",p);var v=l.current,c=f.current;if(v&&c){var h=c.getBoundingClientRect(),g=v.getBoundingClientRect(),b=h.left+h.width/2,_=Math.max(8,Math.min(b-g.width/2,window.innerWidth-8-g.width)),C=h.top-g.height-8;C<8&&(C=h.bottom+8),o({left:_,top:C})}return function(){document.removeEventListener("keydown",d),document.removeEventListener("click",p),o(null)}},[n]),u`
      ...
      </div>`}function Vt(e){var t=Ce(null),n=li(t),r=I(null),i=r[0],a=r[1],o=e.height||180,l=e.series||[],f=e.timeWindow;if(!f){var d=1/0,p=-1/0;l.forEach(function(y){y.points.forEach(function(O){O.t<d&&(d=O.t),O.t>p&&(p=O.t)})}),f=d===1/0?[0,1]:[d,p]}var v=f[0],c=f[1]>f[0]?f[1]:f[0]+1,h=[];l.forEach(function(y){y.points.forEach(function(O){h.push(O.y)})});var g=ci(h,!1),b=Math.max(10,n-j.left-j.right),_=o-j.top-j.bottom;function C(y){return j.left+(y-v)/(c-v)*b}function $(y){return j.top+(1-(y-g[0])/(g[1]-g[0]))*_}var L=ui(g[0],g[1],4),F=e.xTickFormat||function(y){return k.time(y,"hm")},M=ya(v,c,Math.max(2,Math.min(5,Math.floor(b/90)))).map(function(y){return{x:C(y),label:F(y)}});function w(y){var O=[],D=[];y.forEach(function(K){K.y===null||K.y===void 0?(D.length&&O.push(D),D=[]):D.push(K)}),D.length&&O.push(D);var q=$(Math.max(0,g[0]));return O.map(function(K){var m=K.map(function(T,E){return(E===0?"M":"L")+C(T.t).toFixed(1)+" "+$(T.y).toFixed(1)}).join(""),x=m+"L"+C(K[K.length-1].t).toFixed(1)+" "+q.toFixed(1)+"L"+C(K[0].t).toFixed(1)+" "+q.toFixed(1)+"Z";return{line:m,area:x}})}function z(y){if(t.current){var O=t.current.getBoundingClientRect(),D=y.clientX-O.left;if(D<j.left||D>n-j.right){a(null);return}var q=v+(D-j.left)/b*(c-v);a(q)}}var P=null,A=[];return i!==null&&(A.push({text:F(i)}),l.forEach(function(y){var O=cr(y.points,i);O>=0&&(P===null&&(P=C(y.points[O].t)),A.push({color:y.color,text:(y.label?y.label+": ":"")+(e.yFormat||In)(y.points[O].y)+(e.yFormat?"":" "+e.yUnit)}))}),P===null&&(P=C(i))),u`
      <div class="chart" ref=${t}
        onPointerMove=${z}
        onPointerLeave=${function(){a(null)}}>
        ${n>0?u`
          <svg width=${n} height=${o} role="img" aria-label=${e.label||""}>
            <${fi} width=${n} height=${o} sy=${$}
              yTicks=${L} xTicks=${M}
              yUnit=${e.yUnit||"kW"} xUnit=${e.xUnit||"h"} />
            ${(e.bands||[]).map(function(y,O){return Sa(y.top,y.bottom,C,$).map(function(D,q){return u`<path key=${O+"-"+q} class="ch-band" d=${D} fill=${y.color} stroke="none"/>`})})}
            ${l.map(function(y,O){return w(y.points).map(function(D,q){return u`
                  <g key=${O+"-"+q}>
            ...
            ${P!==null?u`
              <line x1=${P} x2=${P} y1=${j.top-4} y2=${o-j.bottom} class="ch-crosshair"/>
              ${l.map(function(y,O){var D=cr(y.points,i);return D>=0?u`
                  <circle key=${O} cx=${C(y.points[D].t)} cy=${$(y.points[D].y)} r="3.5"
                    fill=${y.color} stroke="#fff" stroke-width="1.5"/>`:null})}`:null}
          </svg>
          ${P!==null?di(t,n,P,A):null}`:null}
      </div>`}function pi(e){var t=Ce(null),n=li(t),r=I(null),i=r[0],a=r[1],o=e.height||180,l=e.points||[];function f(m){if(!m.bars)return[m.y];var x=[];return m.bars.forEach(function(T){ka(T).forEach(function(E){x.push(E)})}),x}var d=l.reduce(function(m,x){return x.bars?Math.max(m,x.bars.length):m},1),p=[];l.forEach(function(m){f(m).forEach(function(x){p.push(x)})});var v=ci(p,!0),c=Math.max(10,n-j.left-j.right),h=o-j.top-j.bottom;function g(m){return j.top+(1-(m-v[0])/(v[1]-v[0]))*h}var b=l.length,_=b>0?c/b:c;function C(m){return j.left+(m+.5)*_}var $=Math.max(1,Math.min(_-1,_*.72,46)),L=ui(v[0],v[1],4),F=e.xTickFormat||function(m){return k.time(m,"hm")},M=wa(l,c,F).map(function(m){return{x:C(m),label:F(l[m].t)}}),w=g(0),z=l.length+"|"+(l.length?l[0].t+"-"+l[l.length-1].t:"")+"|"+d+"|"+(e.yUnit||"");function P(m){if(!t.current||!b){a(null);return}var x=t.current.getBoundingClientRect(),T=m.clientX-x.left;if(T<j.left||T>n-j.right){a(null);return}var E=Math.floor((T-j.left)/_);a(E<0?0:E>=b?b-1:E)}var A=e.yFormat||In;function y(m){return A(m)+(e.yFormat?"":" "+(e.yUnit||""))}var O=null,D=[];if(i!==null&&l[i]){var q=l[i];if(O=C(i),D.push({text:F(q.t)}),q.bars)q.bars.forEach(function(m){(m.segments||[]).forEach(function(x){if(x.value){var T=e.signedMagnitude?Math.abs(x.value):x.value;D.push({color:x.color,text:(x.label?x.label+": ":"")+y(T)})}})});else if(q.y!==null&&q.y!==void 0){var K=e.signedMagnitude?Math.abs(q.y):q.y;D.push({color:q.color||e.color,text:(q.label?q.label+": ":"")+y(K)})}}return u`
      <div class="chart" ref=${t}
        onPointerMove=${P}
        onPointerLeave=${function(){a(null)}}>
        ${n>0?u`
          <svg width=${n} height=${o} role="img" aria-label=${e.label||""}>
            ...
            <g class="ch-bars" key=${z}>
            ${l.map(function(m,x){var T=i===x?"1":"0.85";if(m.bars){var E=C(x)-$/2,be=$/d;return u`<g key=${x}>${m.bars.map(function(et,Re){var De=E+Re*be+1,he=Math.max(1,be-2),ye=0,ae=0;return(et.segments||[]).map(function(N,ne){var V=N.value||0;if(!V)return null;var Q,ce;V>0?(Q=ye,ce=ye+V,ye=ce):(Q=ae,ce=ae+V,ae=ce);var tt=Math.min(g(Q),g(ce)),we=Math.max(1,Math.abs(g(ce)-g(Q)));return u`
                      <rect key=${Re+"-"+ne}
                        class=${"ch-bar "+(V>0?"ch-bar-up":"ch-bar-down")}
                        x=${De.toFixed(1)} y=${tt.toFixed(1)}
                        width=${he.toFixed(1)} height=${we.toFixed(1)} rx="1.5"
                        fill=${N.color} opacity=${T}/>`})})}</g>`}if(m.y===null||m.y===void 0)return null;var pe=C(x)-$/2,ve=g(m.y),oe=Math.min(ve,w),Qe=Math.max(1,Math.abs(ve-w));return u`
                <rect key=${x} class=${"ch-bar "+(m.y<0?"ch-bar-down":"ch-bar-up")}
                  x=${pe.toFixed(1)} y=${oe.toFixed(1)}
                  width=${$.toFixed(1)} height=${Qe.toFixed(1)} rx="2"
                  fill=${m.color||e.color||"var(--c-consumption)"}
                  opacity=${T}/>`})}
            </g>
            <line x1=${j.left} x2=${n-j.right} y1=${w} y2=${w} class="ch-zero-strong"/>
          </svg>
...
`){f(),o++;continue}i+=d,o++}return(i!==""||r.length)&&f(),n}function wi(e,t){var n=[pr(e)];return(t||[]).forEach(function(r){n.push(pr(r))}),Oa+n.join(dr)+dr}function Fa(e,t){var n=new Date;function r(a){return(a<10?"0":"")+a}var i=n.getFullYear()+r(n.getMonth()+1)+r(n.getDate());return"gplug-verlauf-"+e+"-"+i+".csv"}var An="gplug-archive",Ra=3,dt=900,vr=384,Da=60,Ba=2*86400,Ua=50,Wa="2",Ha=["1","2"],hr={},gr=!1,He=null,mn=!1;function Ka(){return typeof indexedDB<"u"?indexedDB:typeof globalThis<"u"?globalThis.indexedDB:void 0}function Xe(e){return new Promise(function(t,n){e.onsuccess=function(){t(e.result)},e.onerror=function(){n(e.error||new Error("idb request failed"))}})}function Fn(e){return new Promise(function(t,n){e.oncomplete=function(){t()},e.onabort=e.onerror=function(){n(e.error||new Error("idb tx failed"))}})}function $e(){if(He)return He;var e=Ka();return e?(He=new Promise(function(t,n){var r;try{r=e.open(An,Ra)}catch(i){n(i);return}r.onupgradeneeded=function(){var i=r.result;i.objectStoreNames.contains("e15")||i.createObjectStore("e15",{keyPath:["siteId","ts"]}),i.objectStoreNames.contains("vz15")&&i.deleteObjectStore("vz15"),i.objectStoreNames.contains("meta")||i.createObjectStore("meta",{keyPath:"siteId"}),i.objectStoreNames.contains("live")||i.createObjectStore("live",{keyPath:["siteId","kind","id"]})},r.onsuccess=function(){var i=r.result;i.onversionchange=function(){i.close(),He=null},t(i)},r.onerror=function(){n(r.error||new Error("idb open failed"))},r.onblocked=function(){n(new Error("idb blocked"))}}).catch(function(t){throw mn=!0,He=null,t}),He):(mn=!0,Promise.reject(new Error("IndexedDB unavailable")))}function ja(){return mn?Promise.resolve(!1):$e().then(function(){return!0},function(){return!1})}function Je(e,t,n){return e.transaction(t,n).objectStore(t)}function za(e){return{siteId:e,firstE15Ts:null,lastE15Ts:null,gaps:[],count:0,syncedAt:null}}function Rn(e){return $e().then(function(t){return Xe(Je(t,"meta","readonly").get(e))}).then(function(t){return t||za(e)})}function ki(e){return $e().then(function(t){var n=t.transaction("meta","readwrite");return n.objectStore("meta").put(e),Fn(n).then(function(){return e})})}function qa(){return $e().then(function(e){return Xe(Je(e,"meta","readonly").getAllKeys())}).then(function(e){return(e||[]).map(String)})}function Dn(e,t,n){var r=t??0,i=n??9999999999;return IDBKeyRange.bound([e,r],[e,i])}function Ya(e,t,n){return $e().then(function(r){return Xe(Je(r,"e15","readonly").getAll(Dn(e,t,n)))}).then(function(r){return(r||[]).map(function(i){var a={ts:i.ts,imp_wh:i.imp_wh,exp_wh:i.exp_wh,pv_wh:i.pv_wh};return Bn(a,i),i.partial&&(a.partial=!0),a})})}function xi(e,t){return!t||!t.length?Promise.resolve(0):$e().then(function(n){var r=n.transaction("e15","readwrite"),i=r.objectStore("e15"),a=0;return t.forEach(function(o){if(!(!o||typeof o.ts!="number")){var l={siteId:e,ts:o.ts,imp_wh:pt(o.imp_wh),exp_wh:pt(o.exp_wh),pv_wh:pt(o.pv_wh)};Bn(l,o),o.partial&&(l.partial=!0),i.put(l),a++}}),Fn(r).then(function(){return a})})}function pt(e){return e==null||isNaN(e)?null:Number(e)}var Va=["bat_chg_wh","bat_dis_wh"];function Bn(e,t){Va.forEach(function(n){var r=pt(t[n]);r!==null&&(e[n]=r)})}function Ga(e){for(var t=[],n=1;n<e.length;n++){var r=e[n-1],i=e[n];if(i-r>dt&&(t.push([r+dt,i-dt]),t.length>=Ua))break}return t}function Un(e){return $e().then(function(t){return Xe(Je(t,"e15","readonly").getAllKeys(Dn(e)))}).then(function(t){var n=(t||[]).map(function(r){return r[1]});return n.sort(function(r,i){return r-i}),{count:n.length,firstE15Ts:n.length?n[0]:null,lastE15Ts:n.length?n[n.length-1]:null,gaps:Ga(n)}})}function Wn(e){return Promise.all([Rn(e),Un(e),Za()]).then(function(t){var n=t[0],r=t[1];return{siteId:e,firstE15Ts:r.firstE15Ts,lastE15Ts:r.lastE15Ts,count:r.count,gaps:r.gaps,syncedAt:n.syncedAt,days:r.firstE15Ts===null?0:Math.max(1,Math.round((r.lastE15Ts-r.firstE15Ts)/86400)),estimate:t[2]}})}function Za(){return typeof navigator>"u"||!navigator.storage||!navigator.storage.estimate?Promise.resolve(null):navigator.storage.estimate().then(function(e){return e},function(){return null})}function Xa(){return gr||(gr=!0,typeof navigator>"u"||!navigator.storage||!navigator.storage.persist)?Promise.resolve(null):navigator.storage.persist().then(function(e){return e},function(){return null})}function Ja(e,t){var n;return Rn(t).then(function(r){n=r;var i=0;return r.lastE15Ts!==null&&r.lastE15Ts!==void 0&&(i=r.lastE15Ts+dt,hr[t]||(i=Math.max(0,r.lastE15Ts-Ba))),hr[t]=!0,Qa(e,t,i)}).then(function(){return Un(t)}).then(function(r){return n.firstE15Ts=r.firstE15Ts,n.lastE15Ts=r.lastE15Ts,n.count=r.count,n.gaps=r.gaps,n.syncedAt=Math.floor(Date.now()/1e3),ki(n)}).then(function(){return Xa()}).then(function(){return Wn(t)})}function Qa(e,t,n){var r=0;function i(a){return r>=Da?Promise.resolve():(r++,e.getEnergy("15m",vr,a).then(function(o){return!Array.isArray(o)||!o.length?null:xi(t,o).then(function(){var l=o[o.length-1].ts;return o.forEach(function(f){f.ts>l&&(l=f.ts)}),o.length<vr?null:i(l+dt)})}))}return i(n)}function es(e){return IDBKeyRange.bound([e,"",""],[e,"￿","￿"])}function mr(e,t,n){var r=Object.keys(n||{});return!e||!r.length?Promise.resolve(0):$e().then(function(i){var a=i.transaction("live","readwrite"),o=a.objectStore("live");return r.forEach(function(l){for(var f=n[l]||[],d=[],p=0;p<f.length;p++)d.push(f[p].t,pt(f[p].y));o.put({siteId:e,kind:t,id:String(l),pts:d})}),Fn(a).then(function(){return r.length})})}function _r(e,t,n){var r=n??0;return $e().then(function(i){return Xe(Je(i,"live","readonly").getAll(es(e)))}).then(function(i){var a={};return(i||[]).forEach(function(o){if(!(!o||o.kind!==t||!Array.isArray(o.pts))){for(var l=[],f=0;f+1<o.pts.length;f+=2)o.pts[f]<r||l.push({t:o.pts[f],y:o.pts[f+1]});l.length&&(a[o.id]=l)}}),a})}function ts(e){return $e().then(function(t){return Xe(Je(t,"e15","readonly").getAll(Dn(e)))}).then(function(t){var n=[];return(t||[]).sort(function(r,i){return r.ts-i.ts}).forEach(function(r){n.push(["e",r.ts,rt(r.imp_wh),rt(r.exp_wh),rt(r.pv_wh),r.partial?"1":"0",rt(r.bat_chg_wh),rt(r.bat_dis_wh)])}),wi([An,Wa,e],n)})}function rt(e){return e==null?"":String(e)}function ns(e,t){var n=Aa(e);if(!n.length||n[0][0]!==An)return Promise.reject(new Error("not a gplug archive export"));if(Ha.indexOf(n[0][1])<0)return Promise.reject(new Error("unsupported export format "+n[0][1]));var r=n[0][2];if(t&&r!==t)return Promise.reject(new Error("site mismatch: file "+r+", device "+t));for(var i=t||r,a=[],o=1;o<n.length;o++){var l=n[o];if(!(!l||!l.length)&&l[0]==="e"){var f={ts:Number(l[1]),imp_wh:it(l[2]),exp_wh:it(l[3]),pv_wh:it(l[4])};l[5]==="1"&&(f.partial=!0),Bn(f,{bat_chg_wh:it(l[6]),bat_dis_wh:it(l[7])}),a.push(f)}}return xi(i,a).then(function(){return Un(i)}).then(function(d){return Rn(i).then(function(p){return p.firstE15Ts=d.firstE15Ts,p.lastE15Ts=d.lastE15Ts,p.count=d.count,p.gaps=d.gaps,ki(p)})}).then(function(){return Wn(i)})}function it(e){return e===""||e===void 0?null:Number(e)}var rs=900*1e3,G={available:null,siteId:null,coverage:null,error:null,syncing:!1,otherSites:[]},Dt=[],lt=null,$r=null;function Si(){return G}function Bt(){Dt.forEach(function(e){try{e(G)}catch{}})}function Ci(e){return Dt.push(e),function(){var t=Dt.indexOf(e);t>=0&&Dt.splice(t,1)}}function is(e){return lt||(lt=ja().then(function(t){return G.available=t,t?e.getSite().then(function(n){return G.siteId=n&&n.id?String(n.id):null,G.siteId?qa().then(function(r){G.otherSites=r.filter(function(i){return i!==G.siteId})},function(){}).then(function(){return _n(e)}).then(function(){return $r===null&&typeof setInterval=="function"&&($r=setInterval(function(){_n(e)},rs)),G}):(Bt(),G)},function(){return Bt(),G}):(Bt(),G)}),lt)}function _n(e){return!G.available||!G.siteId||G.syncing?Promise.resolve(G):(G.syncing=!0,Ja(e,G.siteId).then(function(t){G.coverage=t,G.error=null},function(t){G.error=t&&t.message?t.message:"sync failed"}).then(function(){return G.syncing=!1,Bt(),G}))}function Gt(){return lt||Promise.resolve(G)}function as(e){return _n(e)}var Mi={overview:u`<svg viewBox="0 0 20 20" class="nav-icon" aria-hidden="true"><rect x="2.5" y="2.5" width="6" height="6" rx="1.5" fill="currentColor"/><rect x="11.5" y="2.5" width="6" height="6" rx="1.5" fill="currentColor"/><rect x="2.5" y="11.5" width="6" height="6" rx="1.5" fill="currentColor"/><rect x="11.5" y="11.5" width="6" height="6" rx="1.5" fill="currentColor"/></svg>`,history:u`<svg viewBox="0 0 20 20" class="nav-icon" aria-hidden="true"><path d="M3 3v13.5h14" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/><path d="M5.5 12.5l3.5-4 3 2.5 4.5-5.5" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/></svg>`,meter:u`<svg viewBox="0 0 20 20" class="nav-icon" aria-hidden="true"><circle cx="10" cy="10" r="7.5" fill="none" stroke="currentColor" stroke-width="1.6"/><path d="M10 10l3.5-2.5" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"/><path d="M4.2 11.5h1.6M14.2 11.5h1.6M10 4.2v1.4" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"/></svg>`,modbus:u`<svg viewBox="0 0 20 20" class="nav-icon" aria-hidden="true"><rect x="3.5" y="6" width="13" height="8" rx="1.5" fill="none" stroke="currentColor" stroke-width="1.6"/><path d="M6.5 6V3.8M10 6V3.8M13.5 6V3.8M6.5 14v2.2M10 14v2.2M13.5 14v2.2" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"/></svg>`,settings:u`<svg width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    `,burger:u`<svg viewBox="0 0 20 20" class="nav-icon" aria-hidden="true"><path d="M3 5h14M3 10h14M3 15h14" stroke="currentColor" stroke-width="2" stroke-linecap="round"/></svg>`};function br(){return u`
      ...
      </nav>`}function os(e){var t=hi.useRoute(e.routes),n=I(!1),r=n[0],i=n[1],a=I(!1),o=a[0],l=a[1],f=I(null),d=f[0],p=f[1],v=I(!1),c=v[0],h=v[1],g=I(!1),b=g[0],_=g[1];X(function(){return H.onStatus(function($,L){$?p(null):(te(s("error.offline"),{type:"error"}),p(L?new Date(L):new Date))})},[]),X(function(){var $=!1;function L(M){!$&&M.otherSites&&M.otherSites.length&&($=!0,te(s("banner.archive_site_changed",{id:M.siteId}),{type:"warn"}))}var F=Ci(L);return Gt().then(L),F},[]),X(function(){return H.poll(function(){H.getMeta().then(function($){l(!!$&&typeof $.time=="number"&&$.time<1e9)}).catch(function(){})},6e4)},[]),X(function(){H.getMeter().then(function($){h(!!($&&$.values))}).catch(function(){})},[]),X(function(){H.getModbus().then(function($){_(Array.isArray($)&&$.length>0)}).catch(function(){})},[]),X(function(){i(!1)},[t.path]);var C=t.route.component;return u`
      <div class="shell">
        <aside class="sidebar">
          <${br} />
          <${yr} path=${t.path} showMeter=${c} showModbus=${b} />
          <div class="sidebar-foot">${"v0.1.2"}</div>
        </aside>
        ...
        ${r?u`
          <div class="drawer">
            <${yr} path=${t.path} showMeter=${c} showModbus=${b} onNavigate=${function(){i(!1)}} />
          </div>`:null}
      ...
      <${R} group="grid" title=${s("panel.grid")}
        ...
        defaultOpen=${!1}>
        <div class="ov-stats">
          <${St} color="var(--c-consumption)" label=${s("stat.consumption")}
            tooltip=${s("tooltip.consumption")} value=${k.w(l)} />
          <${St} color="var(--c-production)" label=${s("stat.production")}
            value=${k.w(f)} />
          <${St} color="var(--c-export)" dir="out" label=${s("stat.export")}
            value=${k.w(d)} />
          <${St} color="var(--c-import)" dir="in" label=${s("stat.gridop")}
      ...
      <${R} group="production" title=${s("panel.production")}
        ...
        <div class="ov-subgrid">
          ${t.map(function(i){var a=Pi(i),o=a?"var(--c-battery)":"var(--c-production)",l=gt(i),f=Ns(i,Date.now()/1e3),d=a&&!f?Oi(i):null;return u`
      ...
      <${R} group="loads" title=${s("panel.loads")} tooltip=${s("tooltip.loads")}
        ...
        defaultOpen=${!1}>
        <div class="ov-subgrid">
          ${t.map(function(a){var o=Ii(a.state),l=gt(a),f=o==="inactive"?"waiting":"inactive",d=o==="inactive"?"action.request":"action.deactivate";return u`
...
`):s("tooltip.kpi_saving"),a=!!e.showSaving,o=a?u`
      ...
      </div>`}function Zs(e){return e==null||isNaN(e)?"–":e>=1e3?k.num(e/1e3,2)+" t":k.num(e,e<10?2:1)+" kg"}function Xs(){var e=I(null),t=e[0],n=e[1],r=I(null),i=r[0],a=r[1],o=I([]),l=o[0],f=o[1],d=I([]),p=d[0],v=d[1],c=I(null),h=c[0],g=c[1],b=I(null),_=b[0],C=b[1],$=I(function(){return Math.floor(Date.now()/1e3)}),L=$[0],F=$[1],M=I(null),w=M[0],z=M[1],P=I({}),A=P[0],y=P[1],O=I(!1),D=O[0],q=O[1],K=I(0),m=K[1],x=Ce({}),T=Ce({}),E=Ce(!1),be=L,pe=be-sn,ve=[pe,be];X(function(){H.getSite().then(function(W){n(W)}).catch(function(){}),H.getMeta().then(function(W){C(W)}).catch(function(){})},[]),X(function(){var W=!0;function ke(){W&&(E.current=!0,m(function(re){return re+1}))}return Gt().then(function(re){if(W){if(!re||!re.available||!re.siteId){ke();return}var Be=Math.floor(Date.now()/1e3)-sn;return Promise.all([_r(re.siteId,"prod",Be).catch(function(){return{}}),_r(re.siteId,"load",Be).catch(function(){return{}})]).then(function(ge){W&&(Cr(x.current,ge[0]),Cr(T.current,ge[1]),ke())})}},ke).catch(ke),function(){W=!1}},[]),X(function(){return H.poll(function(){H.getEnergy("15m",96).then(function(W){Array.isArray(W)&&g(W)}).catch(function(){})},6e4)},[]),X(function(){return H.poll(function(){var W=Math.floor(Date.now()/1e3);F(W);var ke=W-sn;Promise.all([H.getPower().catch(function(){return null}),H.getLoads().catch(function(){return null}),H.getProductions().catch(function(){return null})]).then(function(re){var Be=re[0],ge=re[1],Pe=re[2];if(Be&&a(Be),ge&&f(ge),Pe&&v(Pe),(Be||ge||Pe)&&z(W),q(!0),Pe&&Pe.forEach(function(Ue){Sr(x.current,Ue.id,W,gt(Ue),ke)}),ge&&ge.forEach(function(Ue){var Qi=Ii(Ue.state)==="active"?gt(Ue):0;Sr(T.current,Ue.id,W,Qi,ke)}),E.current&&(Pe||ge)){var nt=Si();nt&&nt.available&&nt.siteId&&(Pe&&mr(nt.siteId,"prod",x.current).catch(function(){}),ge&&mr(nt.siteId,"load",T.current).catch(function(){}))}})},1e4)},[]);var oe=Is(i),Qe=Li(i,pe,be),et=!!(p&&p.length&&Cs(Qe.pv.map(function(W){return W.y}))&&!A["flow.prod_nodata"]);function Re(){var W=Object.assign({},A);W["flow.prod_nodata"]=!0,y(W)}var De=new Date;De.setHours(0,0,0,0);var he=Math.floor(De.getTime()/1e3),ye=(h||[]).filter(function(W){return W.ts>=he}),ae=_&&_.tariffs||{},N=ae.co2_g_kwh===void 0||ae.co2_g_kwh===null||ae.co2_g_kwh===""?128:Number(ae.co2_g_kwh),ne=wn(ye,{tariffs:ae,co2:N}),V=Number(ae.grid_import_chf_kwh)>0||Number(ae.grid_feedin_chf_kwh)>0,Q=N>0,ce=ye.some(function(W){return W.partial}),tt=ce?s("kpi.today_until",{time:k.time(L,"hm")}):s("kpi.today"),we=(p||[]).some(function(W){return String(W.productionType||"").toUpperCase()==="BATTERY"}),$t=(p||[]).some(function(W){return String(W.productionType||"").toUpperCase()!=="BATTERY"}),bt=!!(oe&&w&&L-w<25&&i&&typeof i.now=="number"&&i.now-oe.ts<Ds),yt=t&&t.location?t.location:null,en=w?u`
      <span class="ov-updated">${s("common.stale",{time:k.time(w,"hm")})}</span>`:null;function tn(W,ke){H.setLoadState(W,ke).then(function(){return H.getLoads()}).then(function(re){re&&f(re)}).catch(function(){te(s("error.toggle"),{type:"error"})})}return u`
      <div>
        <${Ze} title=${t&&t.name?t.name:s("page.overview")}
          subtitle=${yt} actions=${en} />
        ${D?u`
          <${_t}>
            <div class="ov-top">
              <section class="ov-top-flow" aria-labelledby="ov-sec-now">
                <h2 class="ov-section" id="ov-sec-now">${s("section.now")}</h2>
                <${Ks} newest=${oe} hasBattery=${we} hasPv=${$t}
                  soc=${we?Es(p):null}
                  live=${bt} asOf=${oe?oe.ts:null} />
              </section>
              <section class="ov-top-side" aria-labelledby="ov-sec-today">
                <h2 class="ov-section" id="ov-sec-today">${s("section.today")}</h2>
                <${Vs} kpis=${ne} period=${tt} showSaving=${V}
      ...
      </p>`}function lo(){var e=I(Ee.res),t=e[0],n=e[1],r=I(0),i=r[0],a=r[1],o=I(Ee.pageSize),l=o[0],f=o[1],d=I(Ee.chfMode),p=d[0],v=d[1],c=I(Ee.chartMode),h=c[0],g=c[1],b=I({records:null,tariffs:{},producer:!1,err:!1,archived:!1,coverage:null,blocked:!1}),_=b[0],C=b[1],$=I(!0),L=$[0],F=$[1];Ee.res=t,Ee.pageSize=l,Ee.chfMode=p,Ee.chartMode=h,X(function(){var N=!1;F(!0);var ne=Se[t];return Gt().then(function(V){var Q=!!(V.available&&V.siteId),ce=Math.floor(Date.now()/1e3),tt=ce-ln[t];return Promise.all([Q?Ya(V.siteId,tt,ce).catch(function(){return null}):H.getEnergy("15m",ne.count).catch(function(){return null}),H.getMeta().catch(function(){return null}),H.getProductions().catch(function(){return null})]).then(function(we){if(!N){var $t=we[0],bt=we[1],yt=we[2];if($t===null){C({records:null,tariffs:{},producer:!1,err:!0,archived:!1,coverage:null,blocked:V.available===!1}),F(!1);return}var en=bt&&bt.tariffs||{},tn=Array.isArray(yt)&&yt.some(function(W){return W&&W.productionType==="PHOTOVOLTAIC"});C({records:$t,tariffs:en,producer:tn,err:!1,archived:Q,coverage:V.coverage||null,blocked:V.available===!1}),F(!1)}})}),function(){N=!0}},[t]);var M=Zt(_.tariffs),w=Le(function(){if(!_.records)return[];var N=_.records;M&&(N=_.records.map(function(V){return Ei(V,_.tariffs)}));var ne=wr(N,"15m",Se[t].target,_.tariffs);return ne.slice().sort(function(V,Q){return Q.ts-V.ts})},[_.records,_.tariffs,t,M]),z=Le(function(){if(t!=="15m"||!_.records)return{};var N=wr(_.records,"15m","15m",_.tariffs),ne=$s(N,3),V={};return ne.forEach(function(Q){V[N[Q].ts]=!0}),V},[_.records,_.tariffs,t]),P=w.some(function(N){return(N.exp_wh||0)>0}),A=w.some(function(N){return N.bat_chg_wh!=null||N.bat_dis_wh!=null}),y=io(_.producer,P,M,A),O=_.tariffs.co2_g_kwh===void 0||_.tariffs.co2_g_kwh===null||_.tariffs.co2_g_kwh===""?128:Number(_.tariffs.co2_g_kwh),D={tariffs:_.tariffs,co2:O},q=Number(_.tariffs.grid_import_chf_kwh)>0||Number(_.tariffs.grid_feedin_chf_kwh)>0,K=Le(function(){var N={};return w.forEach(function(ne){N[ne.ts]=wn([ne],D)}),N},[w,_.tariffs,O]),m=Le(function(){return wn(w,D)},[w,_.tariffs,O]),x=_.archived?!(_.coverage&&_.coverage.firstE15Ts!==null&&_.coverage.firstE15Ts>Math.floor(Date.now()/1e3)-ln[t]):_.records?_.records.length<Se[t].count:!0,T=so(w,t,x),E=w.length;T.filter(function(N){return N.kind==="row"});var be=Math.max(1,Math.ceil(E/l)),pe=Math.min(i,be-1),ve=pe*l,oe=Math.min(ve+l,E),Qe=uo(T,ve,oe);function et(N){n(N),a(0)}function Re(N){f(+N),a(0)}function De(){var N=y.map(function(Q){return Q.label+(Q.unit?" "+Q.unit:"")}),ne=w.map(function(Q){return po(Q,y,t,K[Q.ts])}),V=wi(N,ne);$o(Fa(t),V)}var he=Le(function(){return ho(ro(w,t),h,p)},[w,h,p,t]),ye=Le(function(){return go(w,t,_.producer)},[w,t,_.producer]),ae=u`
      <div class="verlauf-actions">
        ...
        <${J} secondary onClick=${De} disabled=${E===0}>
          ${s("history.export")}<//>
      </div>`;return u`
      <div>
        <${Ze} title=${s("page.history")} subtitle=${s("history.subtitle")}
          actions=${ae} />

        ${_.blocked?u`
          <div class="banner banner-warn">${s("banner.archive",{days:ut/96})}</div>`:null}
        ...
        ${!_.err&&!L?u`
          <div>
            ${w.length?u`<${_o} summary=${ye} kpis=${m} showSaving=${q} />`:null}
            ...
            <${R} title=${s("history.table.title")}
              ...
              <div class="table-wrap">
                <table class="table verlauf-table">
                  ...
                  <tbody>
                    ${E===0?u`
                      <tr><td class="table-empty" colspan=${y.length}>${s("common.nodata")}</td></tr>`:Qe.map(function(N){return co(N,y,t,z,K)})}
                  </tbody>
                </table>
                ...
                <div class="table-footer">
                  ...
                  <span class="table-pageinfo">
                    ${s("table.pageinfo",{from:E===0?0:ve+1,to:oe,total:E})}
                  </span>
                  <span class="table-nav">
                    <button class="table-navbtn" aria-label=${s("table.prev")}
      ...
      <//>`}function Uo(){var e=I(void 0),t=e[0],n=e[1],r=I(null),i=r[0],a=r[1],o=I(!1),l=o[0],f=o[1],d=I(null),p=d[0],v=d[1],c=Ce([]),h=Ce({u:{},peakImp:0,peakExp:0});X(function(){return H.poll(function(){H.getMeter().then(function(_){if(n(_&&_.values?_.values:null),v(_&&typeof _.now=="number"?_.now:Math.floor(Date.now()/1e3)),!(!_||!_.values)){var C=Pr(_.values),$=h.current;[1,2,3].forEach(function(y){var O=me(C,Di("voltage",y));O!==null&&($.u[y]=No($.u[y],O))});var L=qn(C),F=L.net,M=me(C,ze("meter.f.power_import")),w=me(C,ze("meter.f.power_export"));M!==null&&(M=M*L.scale),w!==null&&(w=w*L.scale),M===null&&F!==null&&(M=F>0?F:0),w===null&&F!==null&&(w=F<0?-F:0),M!==null&&($.peakImp=Ir($.peakImp,M)),w!==null&&($.peakExp=Ir($.peakExp,w)),a({u:Object.assign({},$.u),peakImp:$.peakImp,peakExp:$.peakExp});var z=me(C,ze("meter.f.energy_import")),P=F!==null?F>0:M!==null&&M>0,A=c.current;for(A.push({reg:z,importing:P});A.length>To;)A.shift();f(Mo(A))}}).catch(function(){})},Eo)},[]);var g=t?Pr(t):[],b=p?Math.max(0,Math.floor(Date.now()/1e3)-p):null;return u`
      <div>
        <${Ze} title=${s("page.meter")} subtitle=${s("meter.subtitle")}
          actions=${p?u`
      ...
      <div>
        <${Ze} title=${s("page.modbus")} subtitle=${s("modbus.subtitle")}
          actions=${i?u`
            <span class="meter-updated">
      ...
      <${R} group="grid">
        ...
        <div class="settings-form">
          <${S} label=${s("settings.site.id")} value=${t.id} error=${n.id}
            disabled=${e.idLocked} onInput=${r("id")} />
          <${S} label=${s("settings.site.name")} value=${t.name} error=${n.name} onInput=${r("name")} />
          <${S} label=${s("settings.site.location")} value=${t.location} onInput=${r("location")} />
          <${S} label=${s("settings.site.description")} value=${t.description} onInput=${r("description")} />
        </div>
        <${Qt} disabled=${mt(n)} onSave=${e.onSave} saving=${e.saving} />
      ...
      <${S} label=${s("settings.modbus.url")} value=${t.url} placeholder="192.168.0.102:502"
        error=${n.url} onInput=${r("url")} />
      <${S} label=${s("settings.modbus.unit")} type="number" step="1" min="1" max="247"
      ...
      <${S} label=${s("settings.modbus.register")} type="number" step="1" min="0"
      ...
      <${S} label=${s("settings.modbus.scale")} type="number" step="any" value=${t.scale}
      ...
      <div>
        ...
        <div class="settings-form">
          <${S} label=${s("settings.load.id")} value=${t.id} error=${r.id} onInput=${i("id")} />
          <${S} label=${s("settings.load.name")} value=${t.friendlyName} onInput=${i("friendlyName")} />
          <${S} label=${s("settings.load.power")} type="number" min="0" value=${t.currentPower}
          ...
          <${S} label=${s("settings.load.priority")} type="number" min="1" value=${t.priority}
        ...
        <div class="settings-form">
          ${o==="shelly"?u`
            <${S} label=${s("settings.url.on")} value=${l.on} error=${r["url.on"]} onInput=${a("on")} />
            <${S} label=${s("settings.url.off")} value=${l.off} error=${r["url.off"]} onInput=${a("off")} />
            <${S} label=${s("settings.url.status")} value=${l.status} error=${r["url.status"]} onInput=${a("status")} />`:o==="modbustcp"?u`
            <${Gn} item=${t} errors=${r} patch=${e.patch} />`:u`
            <${S} label=${s("settings.url")} value=${t.url} error=${r.url} onInput=${i("url")} />
            ${o==="homeassistant"?u`
              <${S} label=${s("settings.token")} type="password" value=${t.token} error=${r.token} onInput=${i("token")} />`:null}`}
        </div>
      ...
      <div>
        ...
        <div class="settings-form">
          <${S} label=${s("settings.prod.id")} value=${t.id} error=${n.id} onInput=${r("id")} />
          <${S} label=${s("settings.prod.name")} value=${t.friendlyName} onInput=${r("friendlyName")} />
        ...
        <div class="settings-form">
          ${i==="gplug"?u`
            <${S} label=${s("settings.sensor")} value=${t.sensor} placeholder="z" error=${n.sensor} onInput=${r("sensor")} />
            <${S} label=${s("settings.field")} value=${t.field} error=${n.field} onInput=${r("field")} />
            <${S} label=${s("settings.scale_field")} value=${t.scale_field} placeholder=${Ut(t.field)} error=${n.scale_field} onInput=${r("scale_field")} />
            <${S} label=${s("settings.scale_base")} type="number" step="1" min="-10" value=${t.scale_base} placeholder="0" error=${n.scale_base} onInput=${r("scale_base")} />
            <${S} label=${s("settings.max_power")} type="number" step="1" min="1" value=${t.max_power} error=${n.max_power} onInput=${r("max_power")} />
            <${S} label=${s("settings.stale_after")} type="number" step="1" min="1" value=${t.stale_after} placeholder="600" error=${n.stale_after} onInput=${r("stale_after")} />
            <${S} label=${s("settings.energy_field")} value=${t.energy_field} placeholder="E_AC" error=${n.energy_field} onInput=${r("energy_field")} />
            ...
            <${S} label=${s("settings.energy_scale_field")} value=${t.energy_scale_field} placeholder=${Ut(t.energy_field)} error=${n.energy_scale_field} onInput=${r("energy_scale_field")} />
            <${S} label=${s("settings.energy_scale_base")} type="number" step="1" min="-10" value=${t.energy_scale_base} placeholder="0" error=${n.energy_scale_base} onInput=${r("energy_scale_base")} />`:i==="modbustcp"?u`
            <${Gn} item=${t} errors=${n} patch=${e.patch} />`:u`
            <${S} label=${s("settings.url")} value=${t.url} error=${n.url} onInput=${r("url")} />
            ${i==="homeassistant"?u`
              <${S} label=${s("settings.token")} type="password" value=${t.token} error=${n.token} onInput=${r("token")} />`:null}`}
        </div>
        ${Vn(t.productionType)?u`
          <div class="settings-subhead">${s("settings.battery")}</div>
          <p class="settings-scope">${s("settings.battery_hint")}</p>
          <div class="settings-form">
            <${S} label=${s("settings.capacity")} type="number" step="1" min="1" value=${t.capacity} error=${n.capacity} onInput=${r("capacity")} />
            <${S} label=${s("settings.max_charge_power")} type="number" step="1" min="1" value=${t.maxChargePower} error=${n.maxChargePower} onInput=${r("maxChargePower")} />
            <${S} label=${s("settings.max_discharge_power")} type="number" step="1" min="1" value=${t.maxDischargePower} error=${n.maxDischargePower} onInput=${r("maxDischargePower")} />
            ${i==="gplug"?u`
              <${S} label=${s("settings.soc_field")} value=${t.soc_field} placeholder="ChaState" error=${n.soc_field} onInput=${r("soc_field")} />
              <${S} label=${s("settings.soc_scale_field")} value=${t.soc_scale_field} placeholder=${Ut(t.soc_field)} error=${n.soc_scale_field} onInput=${r("soc_scale_field")} />
              <${S} label=${s("settings.soc_scale_base")} type="number" step="1" min="-10" value=${t.soc_scale_base} placeholder="0" error=${n.soc_scale_base} onInput=${r("soc_scale_base")} />`:i!=="simulator"?u`
              <${S} label=${s("settings.soc_url")} value=${t.soc_url} error=${n.soc_url} onInput=${r("soc_url")} />`:null}
            <label class="toggle-wrap">
      ...
      <div>
        ...
        <div class="settings-form">
          ${i==="gplug"?u`
            ...
            <${S} label=${s("settings.max_power")} type="number" step="1" min="1" value=${t.max_power} error=${n.max_power} onInput=${r("max_power")} />
            <${S} label=${s("settings.stale_after")} type="number" step="1" min="1" value=${t.stale_after} placeholder="600" error=${n.stale_after} onInput=${r("stale_after")} />
            <${S} label=${s("settings.energy_field")} value=${t.energy_field} placeholder="E_AC" error=${n.energy_field} onInput=${r("energy_field")} />`:i==="modbustcp"?u`
            <${Gn} item=${t} errors=${n} patch=${e.patch} />`:u`
            <${S} label=${s("settings.url")} value=${t.url} error=${n.url} onInput=${r("url")} />
            ${i==="homeassistant"?u`
              <${S} label=${s("settings.token")} type="password" value=${t.token} error=${n.token} onInput=${r("token")} />`:null}`}
      ...
      <div>
        ...
        <div class="settings-form">
          <${S} label=${s("settings.modbus.id")} value=${t.id} error=${n.id} onInput=${r("id")} />
          <${S} label=${s("settings.modbus.name")} value=${t.friendlyName} onInput=${r("friendlyName")} />
          <${S} label=${s("settings.modbus.url")} value=${t.url} placeholder="192.168.0.102:502"
            error=${n.url} onInput=${r("url")} />
          <${S} label=${s("settings.modbus.unit")} type="number" step="1" min="1" max="247"
            value=${t.unit} placeholder="1" error=${n.unit} onInput=${r("unit")} />
          ...
          <${S} label=${s("settings.modbus.scale")} type="number" step="any" value=${t.scale}
            placeholder="1" error=${n.scale} onInput=${r("scale")} />
          <${S} label=${s("settings.modbus.unit_label")} value=${t.unitLabel} placeholder="kWh"
            onInput=${r("unitLabel")} />
          <label class="toggle-wrap">
            <input type="checkbox" class="toggle" checked=${t.swap_words===!0}
              onChange=${function(i){e.patch("swap_words",i.target.checked)}} />
      ...
      <${R} group="grid">
        ...
        <div class="settings-form">
          <${S} label=${s("settings.tariff.grid_import_ht_chf_kwh")} type="number" step="0.01" min="0"
            value=${t.grid_import_ht_chf_kwh} error=${n.grid_import_ht_chf_kwh} onInput=${r("grid_import_ht_chf_kwh")} />
          <${S} label=${s("settings.tariff.grid_import_nt_chf_kwh")} type="number" step="0.01" min="0"
        ...
        ${i.map(function(p,v){return u`
            <div key=${v} class="settings-form ht-window-row">
              <${S} label=${s("settings.tariff.win_days")} value=${p.days}
                placeholder=${s("settings.tariff.win_days.ph")} onInput=${function(c){a(v,"days",c)}} />
              <${S} label=${s("settings.tariff.win_from")} type="number" step="0.5" min="0"
                value=${p.from} error=${n["win."+v]} onInput=${function(c){a(v,"from",Br(c))}} />
              <${S} label=${s("settings.tariff.win_to")} type="number" step="0.5" min="0"
        ...
        <div class="settings-form">
          <${S} label=${s("settings.tariff.grid_feedin_chf_kwh")} type="number" step="0.01" min="0"
            value=${t.grid_feedin_chf_kwh} error=${n.grid_feedin_chf_kwh} onInput=${r("grid_feedin_chf_kwh")} />
          <${S} label=${s("settings.tariff.base_fee_chf_month")} type="number" step="0.01" min="0"
        ...
        <div class="settings-form">
          <${S} label=${s("settings.tariff.co2_g_kwh")} type="number" step="1" min="0"
      ...
      </div>`}function gl(){var e=I(null),t=e[0],n=e[1],r=I(!1),i=r[0],a=r[1],o=I(!1),l=o[0],f=o[1],d=I(!1),p=d[0],v=d[1],c=I({scanning:!1,networks:null,error:!1}),h=c[0],g=c[1];function b(){a(!1),n(null),H.getWifiConfig().then(function(w){n({ssid1:w.ssid1,password1:"",ssid2:w.ssid2,password2:""})}).catch(function(){a(!0)})}X(function(){b()},[]);function _(w){return function(z){n(function(P){var A=Object.assign({},P);return A[w]=z,A})}}function C(){p||!window.confirm(s("settings.gplug.restart_confirm"))||(v(!0),H.restartDevice().then(function(){te(s("settings.gplug.restart_success"),{type:"info"})}).catch(function(){te(s("settings.gplug.restart_error"),{type:"error"})}).then(function(){v(!1)}))}function $(){l||!t||mt(Ur(t))||(f(!0),H.setWifiConfig(t).then(function(){te(s("settings.gplug.wifi_saved"),{type:"info"})}).catch(function(w){te(w&&w.message||s("settings.save_error"),{type:"error"})}).then(function(){f(!1)}))}function L(){g({scanning:!0,networks:null,error:!1}),H.wifiScanStart().catch(function(){});var w=0;function z(){w+=1,H.wifiScanResult().then(function(P){var A=P&&(P.WiFiScan!==void 0?P.WiFiScan:P.WifiScan);if(A&&typeof A=="object"){var y=Object.keys(A).map(function(O){return A[O]});y.sort(function(O,D){return(Number(D.RSSI)||0)-(Number(O.RSSI)||0)}),g({scanning:!1,networks:y,error:!1});return}if(w>=10){g({scanning:!1,networks:null,error:!0});return}setTimeout(z,1e3)}).catch(function(){g({scanning:!1,networks:null,error:!0})})}setTimeout(z,1e3)}function F(w,z){n(function(P){var A=Object.assign({},P);return A["ssid"+w]=z,A})}if(i)return u`
        <${R} group="grid">
          <p class="placeholder-text">${s("settings.load_error")}</p>
          <${J} secondary small onClick=${b}>${s("settings.retry")}<//>
        <//>`;if(!t)return u`<${R} group="grid"><p class="placeholder-text">${s("settings.loading")}</p><//>`;var M=Ur(t);return u`
      <div>
        ...
        <${R} group="grid" title=${s("settings.gplug.wifi_title")}>
          ...
          <div class="settings-form">
            <${S} label=${s("settings.gplug.ssid1")} value=${t.ssid1} error=${M.ssid1} onInput=${_("ssid1")} />
            <${S} label=${s("settings.gplug.password1")} type="password" value=${t.password1} error=${M.password1}
          ...
          <div class="settings-form">
            <${S} label=${s("settings.gplug.ssid2")} value=${t.ssid2} error=${M.ssid2} onInput=${_("ssid2")} />
            <${S} label=${s("settings.gplug.password2")} type="password" value=${t.password2} error=${M.password2}
          ...
          <${J} secondary small disabled=${h.scanning} onClick=${L}>
          ...
          ${h.networks&&h.networks.length>0?u`
            <div class="wifi-scan-list">
              ${h.networks.map(function(w,z){return u`<${hl} key=${z} net=${w} onUse=${function(P){F(P,w.SSId)}} />`})}
            </div>`:null}

          <${Qt} disabled=${mt(M)} onSave=${$} saving=${l} />
        <//>
      </div>`}function ml(e,t){var n=new Blob([t],{type:"text/csv;charset=utf-8"}),r=URL.createObjectURL(n),i=document.createElement("a");i.href=r,i.download=e,document.body.appendChild(i),i.click(),document.body.removeChild(i),setTimeout(function(){URL.revokeObjectURL(r)},0)}function Wr(e){return e==null||isNaN(e)?"–":e<1024?e+" B":e<1024*1024?Math.round(e/1024)+" KB":Math.round(e/(1024*1024)*10)/10+" MB"}function _l(){var e=I(null),t=e[0],n=e[1],r=I(Si()),i=r[0],a=r[1],o=I(!1),l=o[0],f=o[1];function d(g){if(!g.available||!g.siteId){n(null);return}Wn(g.siteId).then(n,function(){n(null)})}X(function(){var g=Ci(function(b){a(Object.assign({},b)),d(b)});return Gt().then(function(b){a(Object.assign({},b)),d(b)}),g},[]);function p(){l||(f(!0),as(H).then(function(g){d(g),te(s("settings.data.synced"),{type:"info"})},function(){te(s("settings.data.sync_error"),{type:"error"})}).then(function(){f(!1)}))}function v(){i.siteId&&ts(i.siteId).then(function(g){ml("gplug-archiv-"+i.siteId+".csv",g)},function(){te(s("settings.data.export_error"),{type:"error"})})}function c(g){var b=g.target&&g.target.files&&g.target.files[0];b&&(g.target.value="",b.text().then(function(_){return ns(_,i.siteId)}).then(function(_){n(_),te(s("settings.data.import_ok",{count:_.count}),{type:"info"})},function(_){te(_&&_.message||s("settings.data.import_error"),{type:"error"})}))}if(i.available===!1)return u`
      ...
      <div>
        <${R} group="grid" title=${s("settings.data.title")}>
          ...
          ${t.gaps&&t.gaps.length?u`
            <ul class="data-gaps">
              ${t.gaps.map(function(g,b){return u`<li key=${b}>${k.time(g[0],"15m")} – ${k.time(g[1],"15m")}</li>`})}
      ...
      </div>`}function $l(e){try{return JSON.stringify(JSON.parse(e),null,2)}catch{return e}}function bl(e){var t=I(null),n=t[0],r=t[1],i=I(!1),a=i[0],o=i[1],l=I(!1),f=l[0],d=l[1];function p(){o(!1),r(null),H.getConfigRaw().then(function(g){r($l(g))}).catch(function(){o(!0)})}X(function(){p()},[]);var v=null,c=[];if(n!==null)try{c=ol(JSON.parse(n))}catch(g){v=g.message}function h(){if(!(f||v)){var g;try{g=JSON.parse(n)}catch{return}d(!0),H.postConfig(g).then(function(){te(s("settings.saved"),{type:"info"}),e.onSaved&&e.onSaved(),p()}).catch(function(b){te(b&&b.message||s("settings.save_error"),{type:"error"})}).then(function(){d(!1)})}}return a?u`
        <${R} group="grid">
          <p class="placeholder-text">${s("settings.load_error")}</p>
      ...
      <${R} group="grid">
        ...
        ${c.length?u`
          <div class="settings-warn">
            ...
            <ul class="settings-warn-list">
              ${c.map(function(g,b){return u`<li key=${b}><code>${g.path||"/"}</code> — ${s(g.key)}</li>`})}
            </ul>
      ...
      <//>`}function yl(){return{id:"",friendlyName:"",loadType:xn[0],currentPower:"",priority:1,integration:"simulator",url:""}}function wl(){return{id:"",friendlyName:"",productionType:zt[0],dimension:"W",integration:"simulator",url:""}}function kl(){return{id:"",friendlyName:"",integration:"modbustcp",url:"",unit:1,function:3,register:"",dtype:"float32"}}function xl(e){var t=e.params&&e.params.tab||"site",n=qo[t]||"site",r=I(null),i=r[0],a=r[1],o=I(null),l=o[0],f=o[1],d=I(!1),p=d[0],v=d[1],c=I(!1),h=c[0],g=c[1],b=I({loads:[],productions:[],grid:[],modbusRegisters:[]}),_=b[0],C=b[1];function $(m){return(Array.isArray(m)?m:[]).map(function(x){return String(x&&x.id)}).filter(function(x){return!U(x)})}function L(){f(null),H.getConfig().then(function(m){a(F(m)),g(!U(m&&m.id)),C({loads:$(m&&m.loads),productions:$(m&&m.productions),grid:$(m&&m.grid),modbusRegisters:$(m&&m.modbusRegisters)})}).catch(function(){f(!0),a(null)})}X(function(){L()},[]);function F(m){m=m||{};var x=Object.assign({},m);return x.loads=Array.isArray(m.loads)?m.loads:[],x.productions=Array.isArray(m.productions)?m.productions:[],x.grid=Array.isArray(m.grid)?m.grid:[],x.modbusRegisters=Array.isArray(m.modbusRegisters)?m.modbusRegisters:[],x.tariffs=Object.assign({},Jo,m.tariffs||{}),x}function M(m,x){a(function(T){var E=Object.assign({},T);return E[m]=x,E})}function w(m,x){a(function(T){var E=Object.assign({},T);return E.tariffs=Object.assign({},T.tariffs),E.tariffs[m]=x,E})}function z(m){a(function(x){var T=Object.assign({},x);return T.tariffs=Object.assign({},x.tariffs),T.tariffs.ht_windows=m,T})}function P(m,x){a(function(T){var E=Object.assign({},T);return E[m]=x,E})}function A(){p||(v(!0),H.postConfig(y(i)).then(function(){te(s("settings.saved"),{type:"info"}),g(!0),L()}).catch(function(m){te(m&&m.message||s("settings.save_error"),{type:"error"})}).then(function(){v(!1)}))}function y(m){var x=Object.assign({},m);return x.loads=m.loads.map(function(T){var E=Object.assign({},T);return E.currentPower!==""&&E.currentPower!==void 0&&(E.currentPower=Number(E.currentPower)),E.priority!==""&&E.priority!==void 0&&(E.priority=Number(E.priority)),un(E)}),x.productions=m.productions.map(function(T){return un(Fr(T))}),x.grid=m.grid.map(function(T){return un(Fr(T))}),x.modbusRegisters=m.modbusRegisters.map(function(T){var E=Object.assign({},T);return E.function=Number(E.function||3),E.register=Number(E.register),U(E.unit)?delete E.unit:E.unit=Number(E.unit),U(E.scale)||Number(E.scale)===1?delete E.scale:E.scale=Number(E.scale),U(E.unitLabel)&&delete E.unitLabel,E.swap_words!==!0&&delete E.swap_words,E}),x.tariffs=Object.assign({},m.tariffs),zi.forEach(function(T){x.tariffs[T]=Number(m.tariffs[T])}),m.tariffs.co2_g_kwh!==void 0&&m.tariffs.co2_g_kwh!==""&&(x.tariffs.co2_g_kwh=Number(m.tariffs.co2_g_kwh)),["grid_import_ht_chf_kwh","grid_import_nt_chf_kwh"].forEach(function(T){U(m.tariffs[T])?delete x.tariffs[T]:x.tariffs[T]=Number(m.tariffs[T])}),Array.isArray(m.tariffs.ht_windows)&&(m.tariffs.ht_windows.length===0?delete x.tariffs.ht_windows:x.tariffs.ht_windows=m.tariffs.ht_windows.map(function(T){return{days:T.days,from:Number(T.from),to:Number(T.to)}})),x}function O(m){!m||U(m.id)||H.setLoadState(m.id,"INACTIVE").catch(function(){})}function D(m){hi.navigate("/einstellungen/"+Yo[m])}var q=zo.map(function(m){return u`
        <button key=${m} type="button"
          class=${"pill"+(m===n?" pill-active":"")}
          onClick=${function(){D(m)}}>${s(Vo[m])}</button>`}),K;return l?K=u`
        <${R}>
          <p class="placeholder-text">${s("settings.load_error")}</p>
          <${J} secondary small onClick=${L}>${s("settings.retry")}<//>
        <//>`:i?n==="site"?K=u`<${ll} cfg=${i} patch=${M} idLocked=${h}
        onSave=${A} saving=${p} />`:n==="tariffs"?K=u`<${vl} tariffs=${i.tariffs} patch=${w}
        setWindows=${z} onSave=${A} saving=${p} />`:n==="daten"?K=u`<${_l} />`:n==="gplug"?K=u`<${gl} />`:n==="pro"?K=u`<${bl} onSaved=${L} />`:n==="loads"?K=u`<${Et} group="loads"
        items=${i.loads} onChange=${function(m){P("loads",m)}}
        ...
        onSave=${A} saving=${p} />`:n==="productions"?K=u`<${Et} group="production"
        items=${i.productions} onChange=${function(m){P("productions",m)}}
        listTitle=${s("settings.tab.productions")}
        labelFn=${function(m){return m.friendlyName||m.id||s("settings.new_entry")}}
        blank=${wl} confirmKey="settings.confirm_delete_production"
        persistedIds=${_.productions}
        validate=${function(m,x){return Gi(m,x)}} Detail=${fl}
        onSave=${A} saving=${p} />`:n==="grid"?K=u`<${Et} group="grid" fixedList
        items=${i.grid} onChange=${function(m){P("grid",m)}}
        ...
        onSave=${A} saving=${p} />`:n==="modbus"&&(K=u`<${Et} group="grid"
        items=${i.modbusRegisters} onChange=${function(m){P("modbusRegisters",m)}}
