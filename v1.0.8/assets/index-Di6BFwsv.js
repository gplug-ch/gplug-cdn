...
`||r==="\r"?(c(),a=2):l+=r),a===3&&l==="!--"&&(a=4,f=f[0])}return c(),f})(e)),t),arguments,[])).length>1?t:t[0]}const u=Oi.bind(zr);var et={},Rr="de",Un={};function o(e,t){var n=et[e];return n===void 0?(Un[e]||(Un[e]=!0,console.warn('i18n: missing key "'+e+'"')),e):(t&&(n=n.replace(/\{(\w+)\}/g,function(r,i){return t[i]!==void 0?String(t[i]):r})),n)}function Fi(e){var t=0;function n(){if(t>=e.length)return Promise.reject(new Error("i18n: no language file reachable"));var r=e[t++];return fetch(r).then(function(i){if(!i.ok)throw new Error("HTTP "+i.status);return i.json()}).then(function(i){return et=i||{},Rr=et["meta.lang"]||document.documentElement.lang||"de",et}).catch(function(){return n()})}return n()}const Ri={t:o,load:Fi,getLang:function(){return Rr},getDict:function(){return et}};var nt=" ",Ar="−";function je(e,t){if(e==null||isNaN(e))return"–";var n=e<0,r=Math.abs(Number(e)).toFixed(t),i=r.split(".");return i[0]=i[0].replace(/\B(?=(\d{3})+(?!\d))/g,"'"),r=i.join("."),(n?Ar:"")+r}function Ai(e){return e.indexOf(".")>=0?e.replace(/\.?0+$/,""):e}function Wi(e){return e==null||isNaN(e)?"–":Math.abs(e)>=1e3?Ai(je(e/1e3,1))+nt+"kW":je(Math.round(e),0)+nt+"W"}function Di(e){return e==null||isNaN(e)?"–":Math.abs(e)>=1e3?je(e/1e3,2)+nt+"kWh":je(Math.round(e),0)+nt+"Wh"}function Ui(e,t){if(e==null||isNaN(e))return"–";var n=je(e,2);return t&&e>0&&(n="+"+n),n+nt+"CHF"}function Te(e){return(e<10?"0":"")+e}function Bi(e,t){if(e==null)return"–";var n=new Date(e*1e3),r=Te(n.getDate())+"."+Te(n.getMonth()+1)+"."+n.getFullYear(),i=Te(n.getHours())+":"+Te(n.getMinutes());switch(t){case"1d":return r;case"dm":return Te(n.getDate())+"."+Te(n.getMonth()+1)+".";case"1mo":return Te(n.getMonth()+1)+"."+n.getFullYear();case"q":return n.getFullYear()+" Q"+(Math.floor(n.getMonth()/3)+1);case"hm":return i;case"15m":default:return r+" "+i}}const k={num:je,w:Wi,wh:Di,chf:Ui,time:Bi,MINUS:Ar};function Me(e){return u`
      ...
      <section class=${t}>
        ...
        ${e.children}
      </section>`}function $t(e){var t=String(e.state||"").toLowerCase(),n="state."+t,r="badge badge-"+(t==="active"?"active":t==="waiting"?"waiting":"inactive");return u`<span class=${r}>${o(n)}</span>`}function Y(e){var t=e.danger?"danger":e.secondary?"secondary":"primary";return u`
      <button
        type=${e.type||"button"}
      ...
      </label>`}function ce(e){var t=x(!1),n=t[0],r=t[1],i=x(null),a=i[0],l=i[1],s=be(null),f=be(null);return J(function(){if(!n)return;function c(m){m.key==="Escape"&&r(!1)}function d(m){f.current&&!f.current.contains(m.target)&&r(!1)}document.addEventListener("keydown",c),document.addEventListener("click",d);var h=s.current,v=f.current;if(h&&v){var p=v.getBoundingClientRect(),g=h.getBoundingClientRect(),b=p.left+p.width/2,$=Math.max(8,Math.min(b-g.width/2,window.innerWidth-8-g.width)),y=p.top-g.height-8;y<8&&(y=p.bottom+8),l({left:$,top:y})}return function(){document.removeEventListener("keydown",c),document.removeEventListener("click",d),l(null)}},[n]),u`
      ...
      </span>`}var bt=[],Hi=0;function le(e,t){t=t||{};var n={id:++Hi,message:e,type:t.type||"info",ttl:t.ttl||5e3};bt.forEach(function(r){r(n)})}function ji(){var e=x([]),t=e[0],n=e[1];return J(function(){function r(i){n(function(a){return a.concat([i])}),setTimeout(function(){n(function(a){return a.filter(function(l){return l.id!==i.id})})},i.ttl)}return bt.push(r),function(){var i=bt.indexOf(r);i>=0&&bt.splice(i,1)}},[]),u`
      ...
      </g>`}function Bn(e,t){for(var n=-1,r=1/0,i=0;i<e.length;i++)if(!(e[i].y===null||e[i].y===void 0)){var a=Math.abs(e[i].t-t);a<r&&(r=a,n=i)}return n}function Ki(e,t){var n={};t.forEach(function(i){i.y!==null&&i.y!==void 0&&(n[i.t]=i.y)});var r=[];return e.forEach(function(i){i.y===null||i.y===void 0||n[i.t]!==void 0&&r.push({t:i.t,top:i.y,bottom:n[i.t]})}),r}function Yi(e,t,n,r){var i=Ki(e,t),a=[];if(i.length<2)return a;var l=[];function s(){if(l.length>=2){var g="M"+n(l[0].t).toFixed(1)+" "+r(l[0].top).toFixed(1),b;for(b=1;b<l.length;b++)g+="L"+n(l[b].t).toFixed(1)+" "+r(l[b].top).toFixed(1);for(b=l.length-1;b>=0;b--)g+="L"+n(l[b].t).toFixed(1)+" "+r(l[b].bottom).toFixed(1);a.push(g+"Z")}l=[]}for(var f=0;f<i.length;f++){var c=i[f],d=c.top-c.bottom;if(d>0?l.push(c):s(),f<i.length-1){var h=i[f+1],v=h.top-h.bottom;if(d>0!=v>0&&d!==v){var p=d/(d-v);l.push({t:c.t+(h.t-c.t)*p,top:c.top+(h.top-c.top)*p,bottom:c.bottom+(h.bottom-c.bottom)*p}),d>0&&s()}}}return s(),a}function Hr(e,t,n,r){var i=n>t-150;return u`
      ...
      </div>`}function hn(e){var t=be(null),n=Wr(t),r=x(null),i=r[0],a=r[1],l=e.height||180,s=e.points||[];function f(_){return(_.segments||[]).reduce(function(S,A){return S+(A.value||0)},0)}function c(_){return _.bars?_.bars.map(f):[_.y]}var d=s.reduce(function(_,S){return S.bars?Math.max(_,S.bars.length):_},1),h=[];s.forEach(function(_){c(_).forEach(function(S){h.push(S)})});var v=Ur(h,!0),p=Math.max(10,n-K.left-K.right),g=l-K.top-K.bottom;function b(_){return K.top+(1-(_-v[0])/(v[1]-v[0]))*g}var $=s.length,y=$>0?p/$:p;function m(_){return K.left+(_+.5)*y}var w=Math.max(1,Math.min(y-1,y*.72,46)),M=Dr(v[0],v[1],4),z=e.xTickFormat||function(_){return k.time(_,"hm")},I=qi(s,p,z).map(function(_){return{x:m(_),label:z(s[_].t)}}),U=b(0),N=s.length+"|"+(s.length?s[0].t+"-"+s[s.length-1].t:"")+"|"+d+"|"+(e.yUnit||"");function O(_){if(!t.current||!$){a(null);return}var S=t.current.getBoundingClientRect(),A=_.clientX-S.left;if(A<K.left||A>n-K.right){a(null);return}var D=Math.floor((A-K.left)/y);a(D<0?0:D>=$?$-1:D)}var C=e.yFormat||pn;function E(_){return C(_)+(e.yFormat?"":" "+(e.yUnit||""))}var T=null,B=[];if(i!==null&&s[i]){var R=s[i];T=m(i),B.push({text:z(R.t)}),R.bars?R.bars.forEach(function(_){(_.segments||[]).forEach(function(S){S.value&&B.push({color:S.color,text:(S.label?S.label+": ":"")+E(S.value)})})}):R.y!==null&&R.y!==void 0&&B.push({color:R.color||e.color,text:E(R.y)})}return u`
      <div class="chart" ref=${t}
        onPointerMove=${O}
        onPointerLeave=${function(){a(null)}}>
        ${n>0?u`
          <svg width=${n} height=${l} role="img" aria-label=${e.label||""}>
            <${Br} width=${n} height=${l} sy=${b}
              yTicks=${M} xTicks=${I}
      ...
      </div>`}var Gi=[10,25,50];function Zi(e){var t=x(0),n=t[0],r=t[1],i=x(e.pageSize||10),a=i[0],l=i[1],s=e.rows||[],f=s.length,c=Math.max(1,Math.ceil(f/a)),d=Math.min(n,c-1),h=d*a,v=Math.min(h+a,f),p=s.slice(h,v);return u`
      <div class="table-wrap">
        <table class="table">
          ...
          <tbody>
            ${f===0?u`
              <tr><td class="table-empty" colspan=${e.columns.length}>${o("common.nodata")}</td></tr>`:p.map(function(g,b){return u`
    ...
    `,burger:u`<svg viewBox="0 0 20 20" class="nav-icon" aria-hidden="true"><path d="M3 5h14M3 10h14M3 15h14" stroke="currentColor" stroke-width="2" stroke-linecap="round"/></svg>`};function Zn(){return u`
      ...
      </div>`}function Ra(e){var t=e.newest,n=e.win,r=e.power,i=e.vzevW,a=t?Le(t.grid_w):null,l=t?Le(t.pv_w)||0:null,s=t?Le(t.bat_w)||0:null,f=t&&a!==null?l+s+a:null,c=t?l+s:null,d=t&&a!==null?Math.max(0,-a):null,h=t&&a!==null?Math.max(0,a):null,v=Fa(r,n[0],n[1]),p=v.cons,g=v.prod;return u`
      <${W} group="grid" title=${o("panel.grid")}>
        <div class="ov-stats">
          <${Ze} color="var(--c-consumption)" label=${o("stat.consumption")}
            tooltip=${o("tooltip.consumption")} value=${k.w(f)} />
          <${Ze} color="var(--c-production)" label=${o("stat.production")}
            value=${k.w(c)} />
          <${Ze} color="var(--c-vzev)" label=${o("stat.export")}
            value=${k.w(d)} />
          <${Ze} color="var(--c-import)" label=${o("stat.gridop")}
      ...
      <${W} group="production" title=${o("panel.production")}>
        ${e.notice?u`
        ...
        <div class="ov-subgrid">
          ${t.map(function(i){var a=Pa(i),l=a?"var(--c-battery)":"var(--c-production)",s=Nt(i);return u`
              <div key=${i.id} class="ov-sub">
                ...
                <${at} height=${150} yUnit="W" xUnit="h" timeWindow=${r}
                  yFormat=${k.w}
                  series=${[{points:n[i.id]||[],color:l,label:a?o("stat.battery"):er(i)}]} />
              </div>`})}
        </div>
      <//>`}function Wa(e){var t=e.loads,n=e.history,r=e.win,i=e.onToggle;return!t||!t.length?null:u`
      <${W} group="loads" title=${o("panel.loads")} tooltip=${o("tooltip.loads")}>
        <div class="ov-subgrid">
          ${t.map(function(a){var l=kn(a.state),s=Nt(a),f=l==="inactive"?"waiting":"inactive",c=l==="inactive"?"action.request":"action.deactivate";return u`
      ...
      <${W} group="vzev" title=${o("panel.vzev")} tooltip=${o("tooltip.vzev")}>
        <div class="ov-subgrid">
      ...
      <//>`}function Ka(e,t,n,r,i,a,l){var s=a,f=e-n*s,c=t-r*s,d=-r,h=n,v=s*.6,p=e.toFixed(1)+","+t.toFixed(1)+" "+(f+d*v).toFixed(1)+","+(c+h*v).toFixed(1)+" "+(f-d*v).toFixed(1)+","+(c-h*v).toFixed(1);return u`<polygon points=${p} fill=${i} opacity=${l===void 0?1:l} />`}function rr(e){var t=(e.segments||[]).filter(function(i){return i.value>0}),n=t.reduce(function(i,a){return i+a.value},0),r=e.unknown||n<=0;return u`
      <div class="comp-row">
      ...
      </div>`}function Ya(e){var t=x("now"),n=t[0],r=t[1],i=n==="now"?Ma(e.sample,e.vzevW):Na(e.records),a=n==="now"?k.w:k.wh,l=n==="today"?o("flow.comp_batt_note"):null;return u`
      <div class="comp-wrap">
        ...
        <${rr} title=${o("flow.comp_cover")} segments=${i.cover}
          unknown=${i.unknown} fmt=${a} />
        <${rr} title=${o("flow.comp_usage")} segments=${i.usage}
...
`):o("tooltip.kpi_saving"),l=t.autarkyVzev!==null&&t.autarkyVzev!==void 0?o("kpi.autarky_vzev")+": "+r(t.autarkyVzev):null,s=!!e.showSaving,f=s?u`
        ...
        label=${o("kpi.autarky")} tip=${n||o("tooltip.kpi_autarky")} sub=${l} />`),c.push(u`<${jt} key="su" gauge ratio=${t.selfuse} color="var(--c-production)"
      label=${o("kpi.selfuse")} tip=${n||o("tooltip.kpi_selfuse")} />`),e.showCo2&&c.push(u`<${jt} key="co" value=${Qa(t.co2Kg)} color="var(--c-production)"
...
`)>=0||t.indexOf("\r")>=0?'"'+t.replace(/"/g,'""')+'"':t}function ar(e){return(e||[]).map(el).join(ai)}function li(e,t){var n=[ar(e)];return(t||[]).forEach(function(r){n.push(ar(r))}),Ja+n.join(ir)+ir}function tl(e,t){var n=new Date;function r(a){return(a<10?"0":"")+a}var i=n.getFullYear()+r(n.getMonth()+1)+r(n.getDate());return"gplug-verlauf-"+e+"-"+i+".csv"}var nl=[10,25,50],ge={"15m":{label:"history.res.15m",base:"15m",count:240,target:"15m",tk:"15m",slot:900},"1h":{label:"history.res.hour",base:"15m",count:240,target:"1h",tk:"15m",slot:3600},"1d":{label:"history.res.day",base:"1d",count:125,target:"1d",tk:"1d",slot:86400},"1w":{label:"history.res.week",base:"1d",count:125,target:"1w",tk:"1d",slot:604800},"1mo":{label:"history.res.month",base:"1mo",count:19,target:"1mo",tk:"1mo",slot:2592e3},"1q":{label:"history.res.quarter",base:"1mo",count:19,target:"1q",tk:"q",slot:7776e3}},rl=["15m","1h","1d","1w","1mo","1q"],il={"15m":32,"1h":24,"1d":31,"1w":13,"1mo":13,"1q":9},xe={res:"15m",pageSize:25,chfMode:!1,chartMode:"net"};function al(e){return e==null?null:e/1e3}function ll(e,t){var n;return t==="1mo"?(n=new Date(e*1e3),Math.floor(Date.UTC(n.getUTCFullYear(),n.getUTCMonth()-1,1)/1e3)):t==="1q"?(n=new Date(e*1e3),Math.floor(Date.UTC(n.getUTCFullYear(),n.getUTCMonth()-3,1)/1e3)):e-ge[t].slot}function ol(e,t){if(!e.length)return[];var n=il[t]||e.length,r={};e.forEach(function(f){r[f.ts]=f});for(var i=e[e.length-1].ts,a=[],l=e[0].ts,s=0;s<n&&l>=i;s++)a.push(r[l]||{ts:l,__blank:!0}),l=ll(l,t);return a}function Vt(e,t){var n=al(e);return n===null?"–":k.num(n,2)}function sl(e){if(e==null)return u`<span>–</span>`;var t=e>0?"val-pos":e<0?"val-neg":"";return u`<span class=${t}>${k.chf(e,!0)}</span>`}function Qe(e,t){return e==null?u`<span>–</span>`:u`<span class=${t||""}>${k.chf(e,!1)}</span>`}function ul(e,t,n){var r=[{key:"ts",label:o("history.col.time")},{key:"imp",label:o("history.col.gridimport"),unit:"[kWh]",align:"right"}];return n?(r.push({key:"impcost_ht",label:o("history.col.gridcost_ht"),unit:"[CHF]",align:"right"}),r.push({key:"impcost_nt",label:o("history.col.gridcost_nt"),unit:"[CHF]",align:"right"})):r.push({key:"impcost",label:o("history.col.gridcost"),unit:"[CHF]",align:"right"}),e&&t&&r.push({key:"exp",label:o("history.col.feedin"),unit:"[kWh]",align:"right"}),r.push({key:"vzev",label:o(e?"history.col.vzevexport":"history.col.vzevimport"),unit:"[kWh]",align:"right"}),r.push({key:"saldo",label:o("history.col.vzevsaldo"),unit:"[CHF]",align:"right"}),e&&(r.push({key:"saving",label:o("history.col.selfuse"),unit:"[CHF]",align:"right"}),r.push({key:"autarky",label:o("history.col.autarky"),unit:"[%]",align:"right"}),r.push({key:"selfuserate",label:o("history.col.selfuserate"),unit:"[%]",align:"right"}),r.push({key:"ersparnis",label:o("history.col.ersparnis"),unit:"[CHF]",align:"right"})),r}function lr(e){return e==null?"–":k.num(e*100,0)+" %"}function xn(e){var t=e.revenue_vzev_chf,n=e.cost_vzev_chf;return t===null&&n===null?null:(t||0)-(n||0)}function cl(e,t,n){for(var r=ge[t].slot,i=[],a=0;a<e.length;a++){i.push({kind:"row",rec:e[a]});var l=e[a+1];if(l){var s=Math.round((e[a].ts-l.ts)/r)-1;s>=1&&i.push({kind:"gap",key:"g"+e[a].ts})}}return!n&&e.length&&i.push({kind:"boundary",key:"b"+e[e.length-1].ts}),i}function fl(){var e=x(xe.res),t=e[0],n=e[1],r=x(0),i=r[0],a=r[1],l=x(xe.pageSize),s=l[0],f=l[1],c=x(xe.chfMode),d=c[0],h=c[1],v=x(xe.chartMode),p=v[0],g=v[1],b=x({records:null,tariffs:{},producer:!1,base15m:null,err:!1}),$=b[0],y=b[1],m=x(!0),w=m[0],M=m[1];xe.res=t,xe.pageSize=s,xe.chfMode=d,xe.chartMode=p,J(function(){var L=!1;M(!0);var ee=ge[t];return Promise.all([F.getEnergy(ee.base,ee.count).catch(function(){return null}),F.getMeta().catch(function(){return null}),F.getProductions().catch(function(){return null}),ee.base==="15m"?Promise.resolve(null):F.getEnergy("15m",240).catch(function(){return null})]).then(function(ae){if(!L){var oe=ae[0],Re=ae[1],ot=ae[2],ye=ae[3];if(oe===null){y({records:null,tariffs:{},producer:!1,base15m:null,err:!0}),M(!1);return}var qe=Re&&Re.tariffs||{},Ft=Array.isArray(ot)&&ot.some(function(st){return st&&st.productionType==="PHOTOVOLTAIC"}),Rt=ee.base==="15m"?oe:ye||null;y({records:oe,tariffs:qe,producer:Ft,base15m:Rt,err:!1}),M(!1)}}),function(){L=!0}},[t]);var z=Ot($.tariffs)&&ge[t].base==="15m",I=Ee(function(){if(!$.records)return[];var L=$.records;z&&(L=$.records.map(function(ae){return qr(ae,$.tariffs)}));var ee=Hn(L,ge[t].base,ge[t].target,$.tariffs);return ee.slice().sort(function(ae,oe){return oe.ts-ae.ts})},[$.records,$.tariffs,t,z]),U=Ee(function(){if(t!=="15m"||!$.base15m)return{};var L=Hn($.base15m,"15m","15m",$.tariffs),ee=oa(L,3),ae={};return ee.forEach(function(oe){ae[L[oe].ts]=!0}),ae},[$.base15m,$.tariffs,t]),N=I.some(function(L){return(L.exp_wh||0)>0}),O=ul($.producer,N,z),C=I.some(function(L){return(L.vzev_in_wh||0)>0||(L.vzev_out_wh||0)>0}),E=$.tariffs.co2_g_kwh===void 0||$.tariffs.co2_g_kwh===null||$.tariffs.co2_g_kwh===""?128:Number($.tariffs.co2_g_kwh),T={tariffs:$.tariffs,vzev:C,co2:E},B=Number($.tariffs.grid_import_chf_kwh)>0||Number($.tariffs.grid_feedin_chf_kwh)>0,R=Ee(function(){var L={};return I.forEach(function(ee){L[ee.ts]=an([ee],T)}),L},[I,$.tariffs,C,E]),_=Ee(function(){return an(I,T)},[I,$.tariffs,C,E]),S=$.records?$.records.length<ge[t].count:!0,A=cl(I,t,S),D=I.length;A.filter(function(L){return L.kind==="row"});var ue=Math.max(1,Math.ceil(D/s)),se=Math.min(i,ue-1),j=se*s,X=Math.min(j+s,D),pe=vl(A,j,X);function fe(L){n(L),a(0)}function P(L){f(+L),a(0)}function V(){var L=O.map(function(oe){return oe.label+(oe.unit?" "+oe.unit:"")}),ee=I.map(function(oe){return hl(oe,O,t,$.producer,R[oe.ts])}),ae=li(L,ee);yl(tl(t),ae)}var G=Ee(function(){return ml(ol(I,t),p,d,$.producer)},[I,p,d,$.producer,t]),ne=Ee(function(){return $l(I,t,$.producer)},[I,t,$.producer]),Fe=u`
              ...
              <div class="chart-toolbar">
                <div class="seg-toggle" role="tablist" aria-label=${o("history.chart.mode")}>
                  ${[["net","history.chart.mode_net"],["bilanz","history.chart.mode_bilanz"]].map(function(L){return u`<button key=${L[0]} type="button" role="tab"
                      ...
                      aria-selected=${p===L[0]}
                      onClick=${function(){g(L[0])}}>${o(L[1])}</button>`})}
                </div>
                ${p==="net"?u`
            ...
            <${W} title=${o("history.table.title")}>
              <div class="table-wrap">
                <table class="table verlauf-table">
                  ...
                  <tbody>
                    ${D===0?u`
                      <tr><td class="table-empty" colspan=${O.length}>${o("common.nodata")}</td></tr>`:pe.map(function(L){return dl(L,O,t,U,$.producer,R)})}
                  </tbody>
                </table>
                ...
                <div class="table-footer">
                  ...
                  <span class="table-pageinfo">
                    ${o("table.pageinfo",{from:D===0?0:j+1,to:X,total:D})}
                  </span>
                  <span class="table-nav">
                    <button class="table-navbtn" aria-label=${o("table.prev")}
      ...
      </div>`}function vl(e,t,n){for(var r=[],i=-1,a=0;a<e.length;a++){var l=e[a];if(l.kind==="row"){if(i++,i>=n)break;i>=t&&r.push(l)}else i>=t&&i<n&&r.push(l)}return r}function dl(e,t,n,r,i,a){if(e.kind==="boundary")return u`<tr key=${e.key} class="verlauf-boundary">
      ...
      <span class="meter-derived-wrap">
        ...
        <${ce} text=${e.tip} />
      </span>`}function El(){return u`<span class="meter-tag meter-tag-derived">${o("meter.derived")}</span>`}function Pl(){return u`
      <span class="meter-tag meter-tag-register">${o("meter.register")}
        <${ce} text=${o("meter.tip.register")} /></span>`}function si(e){return e==null?"":e>0?"var(--c-import)":e<0?"var(--c-vzev)":""}function Ll(e){var t=e.resolved,n=_e(t,Pe("meter.f.power_net")),r=!1;if(n===null){var i=_e(t,Pe("meter.f.power_import")),a=_e(t,Pe("meter.f.power_export"));(i!==null||a!==null)&&(n=(i||0)-(a||0),r=!0)}if(n===null){var l=null;[1,2,3].forEach(function(c){var d=_e(t,Cn("power",c));d!==null&&(l=(l||0)+d)}),l!==null&&(n=l,r=!0)}if(n===null)return null;var s=n>0,f=o(s?"meter.importing":"meter.exporting");return u`
      <${W} group="grid" title=${o("meter.section.power")}
      ...
      <${W} title=${o("meter.section.phases")} tooltip=${o("meter.tip.phases")}>
            ...
            <tbody>
              ...
              ${l?u`
                <tr class="meter-row-derived">
                  <th scope="row" class="meter-th-metric">
                    <${cr} tip=${o("meter.tip.cosphi")}>cos φ<//>
                  </th>
        ...
        ${a!==null?u`
          <div class="meter-imbalance">
            <${cr} tip=${o("meter.tip.imbalance")}>${o("meter.imbalance")}<//>
      ...
      <${W} group="production" title=${o("meter.section.registers")}
        ...
        ${n.length?u`
          <dl class="meter-reg-list">
            ${n.map(function(a){var l=ln(a.raw);return u`
                <div class="meter-reg">
                  <dt>${o(a.desc.i18nKey)} <span class="meter-unit">[${a.desc.unit}]</span> ${Pl()}</dt>
      ...
      <${W} title=${o("meter.section.minmax")} subtitle=${o("meter.since_open")}
      ...
      <//>`}function Wl(e){var t=e.resolved,n=x(!1),r=n[0],i=n[1],a=t.filter(function(f){return f.desc}),l=t.filter(function(f){return!f.desc});function s(f){var c=!!f.desc,d=f.raw!==null&&typeof f.raw=="object"?JSON.stringify(f.raw):String(f.raw);return u`
        <tr>
      ...
      <div>
        ...
        ${t?u`
          ...
          <${Al} stats=${i} />
          <${Wl} resolved=${g} />`:null}
      </div>`}var Ul=50;function Bl(e,t){if(!e||!e.data)return[];var n=e.producer_id,r=n&&e.data[n],i={},a=[],l=r?[r]:Object.keys(e.data).map(function(s){return e.data[s]});return l.forEach(function(s){if(s)for(var f=0;f+2<s.length;f+=3){var c=s[f];t&&(c<t[0]||c>=t[1])||i[c]||(i[c]=!0,a.push(c))}}),a.sort(function(s,f){return f-s}),a}function Hl(e,t,n){var r=ga(e,t,n),i=k.time(e,"hm"),a=k.time(e+900,"hm");return!r||r.prodWh<=0?o("explain.noprod",{from:i,to:a}):o("explain.sentence",{from:i,to:a,prod:k.wh(r.prodWh),member:k.wh(r.memberImpWh),total:k.wh(r.totalImpWh),share:k.num(r.sharePct,0),alloc:k.wh(r.allocatedWh)})}function ui(e){var t=x(0),n=t[0],r=t[1],i=Bl(e.raw,e.range),a=i.slice(0,(n+1)*Ul),l=a.length<i.length;return u`
      ...
      </span>`}function Zl(){var e=x(null),t=e[0],n=e[1],r=x({}),i=r[0],a=r[1],l=x([]),s=l[0],f=l[1],c=x(!1),d=c[0],h=c[1],v=x(null),p=v[0],g=v[1],b=x(fr),$=b[0],y=b[1],m=x(null),w=m[0],M=m[1],z=be(!0);function I(){F.getVzevMembersList().then(function(P){z.current&&(n(P),h(!1))}).catch(function(){z.current&&(n([]),h(!0))}),F.getVzevRaw().then(function(P){z.current&&g(P||null)}).catch(function(){z.current&&g(null)})}J(function(){z.current=!0,I(),F.getVzevDiscovered().then(function(V){z.current&&f(V)}).catch(function(){z.current&&f([])});var P=F.poll(function(){F.getVzevFlows("15m",1).then(function(V){z.current&&a(Yl(V&&V.flows))}).catch(function(){})},2e3);return function(){z.current=!1,P()}},[]);function U(){fr=!0,y(!0)}function N(P){F.get("/api/vzev/members?action=remove&id="+encodeURIComponent(P.id)).then(function(){le(o("vzev.removed"),{type:"info"}),I()}).catch(function(){le(o("vzev.saveerror"),{type:"error"})})}var O=!!(p&&p.self_id!=null&&p.self_id===p.producer_id),C=O?u`
      <${Y} secondary onClick=${function(){Se.navigate("/vzev/abrechnung")}}>
        ${o("vzev.billing")} ›
      <//>`:null,E=u`<${Me} title=${o("page.vzev")} subtitle=${o("vzev.subtitle")} actions=${C} />`;if(t===null)return u`<div>${E}<${W}><p class="placeholder-text">${o("common.loading")}</p><//></div>`;var T=null,B=[];t.forEach(function(P){P.own||P.is_own?T=P:B.push(P)}),t.forEach(function(P){Xe(P)});var R=u`
      ...
      <${W} class="vz-drill">
        ...
        <${W} group="vzev" class="vz-graph-card">
          <div class="vz-graph" role="img" aria-label=${o("vzev.graph.aria")}>
            <div class="vz-ring">
              ${P.length===0?u`<p class="placeholder-text vz-ring-empty">${o("vzev.empty")}</p>`:P.map(function(V){var G=Xe(V),ne=_(V);return u`
      ...
      <div>
        ...
        ${X}
        ${R}
      </div>`}function dr(e){return e&&(e.type==="PRODUCER"||e.typ==="P")?"P":"C"}function Ql(e){if(e==null||e===0)return"";var t=new Date(e*1e3);function n(r){return(r<10?"0":"")+r}return t.getFullYear()+"-"+n(t.getMonth()+1)+"-"+n(t.getDate())}function Xl(e){if(!e)return null;var t=/^(\d{4})-(\d{2})-(\d{2})$/.exec(String(e));if(!t)return null;var n=new Date(Number(t[1]),Number(t[2])-1,Number(t[3]),0,0,0,0);return Math.floor(n.getTime()/1e3)}function Jl(e){var t=e.params&&e.params.id||null,n=x(""),r=n[0],i=n[1],a=x(""),l=a[0],s=a[1],f=x("C"),c=f[0],d=f[1],h=x(""),v=h[0],p=h[1],g=x(""),b=g[0],$=g[1],y=x([]),m=y[0],w=y[1],M=x(!!t),z=M[0],I=M[1],U=x(!1),N=U[0],O=U[1],C=x(!1),E=C[0],T=C[1],B=x(""),R=B[0],_=B[1];J(function(){var j=!1;return Promise.all([F.getVzevMembersList().catch(function(){return[]}),t?F.getVzevDiscovered().catch(function(){return[]}):Promise.resolve([])]).then(function(X){if(!j){var pe=X[0]||[],fe=X[1]||[];w(pe);for(var P=null,V=0;V<pe.length;V++)if(pe[V].id===t){P=pe[V];break}if(P)I(!0),i(P.name||""),s(P.location||P.loc||""),d(dr(P)),p(P.metering_point||""),$(Ql(P.entry_ts));else if(t){I(!1);for(var G=null,ne=0;ne<fe.length;ne++)if(fe[ne].id===t){G=fe[ne];break}G&&(i(G.name||""),s(G.location||G.loc||""),d(dr(G)))}O(!0)}}),function(){j=!0}},[t]);function S(){if(c!=="P")return!1;for(var j=0;j<m.length;j++){var X=m[j];if(X.id!==t&&(X.type==="PRODUCER"||X.typ==="P"))return!0}return!1}function A(){if(_(""),!r.trim()){_(o("vzev.form.err.name"));return}if(S()){_(o("vzev.form.err.producer"));return}T(!0);var j="/api/vzev/members?action=upsert&id="+encodeURIComponent(t||"")+"&name="+encodeURIComponent(r.trim())+"&loc="+encodeURIComponent(l.trim())+"&typ="+encodeURIComponent(c)+"&mp="+encodeURIComponent(v.trim()),X=Xl(b);X!==null&&(j+="&entry="+X),F.get(j).then(function(){le(o("vzev.saved"),{type:"info"}),Se.navigate("/vzev")}).catch(function(){T(!1),le(o("vzev.saveerror"),{type:"error"})})}function D(){T(!0),F.get("/api/vzev/members?action=remove&id="+encodeURIComponent(t)).then(function(){le(o("vzev.removed"),{type:"info"}),Se.navigate("/vzev")}).catch(function(){T(!1),le(o("vzev.saveerror"),{type:"error"})})}var ue=o(z?"vzev.form.edit":"vzev.form.add"),se=u`<${Me} title=${ue} subtitle=${o("vzev.form.subtitle")} />`;return N?u`
      <div>
        ${se}
        <${W} class="vz-form-card">
          <div class="vz-form">
            <${_t} label=${o("vzev.form.name")} value=${r}
              placeholder=${o("vzev.form.name.ph")}
              onInput=${function(j){i(j)}} />
            <${_t} label=${o("vzev.form.loc")} value=${l}
              placeholder=${o("vzev.form.loc.ph")}
              onInput=${function(j){s(j)}} />
            <${Lt} label=${o("vzev.form.typ")} value=${c}
              onChange=${function(j){d(j),_("")}}
              options=${[{value:"C",label:o("vzev.type.consumer")},{value:"P",label:o("vzev.type.producer")}]} />

            <${_t} label=${o("vzev.form.metering_point")} value=${v}
      ...
      <${W} class="billing-quality">
        <div class="billing-quality-head">
          ...
          ${Tt(t)?u`<span class="billing-provisional">${o("billing.provisional.badge")}</span>`:null}
        </div>
        ...
        ${i.length===0&&!Tt(t)?u`<p class="billing-quality-line billing-quality-ok">${o("billing.quality.ok")}</p>`:null}
      ...
      </div>`}function mr(e){var t=e.wh!==null&&e.wh!==void 0?e.wh/1e3:null,n=x(!1),r=n[0],i=n[1],a=x(!1),l=a[0],s=a[1],f=!!e.member;return u`
      ...
      </div>`}function xo(e){var t=e.item,n=e.otherIds,r=pi(t,n);function i(f){return function(c){e.patch(f,c)}}function a(f){return function(c){var d=Object.assign({},t.url||{});d[f]=c,e.patch("url",d)}}var l=t.integration||"simulator",s=l==="shelly"?t.url||{}:{};return u`
      <div>
        ...
        <div class="settings-form">
          ...
          <${Oe} label=${o("settings.load.type")} value=${t.loadType||sn[0]}
          ...
          <${Oe} label=${o("settings.integration")} value=${l}
      ...
      </div>`}function zo(e){var t=e.item,n=hi(t,e.otherIds);function r(a){return function(l){e.patch(a,l)}}var i=t.integration||"simulator";return u`
      <div>
        <div class="md-detail-head">
          <h3 class="md-detail-title">${t.friendlyName||t.id||o("settings.new_entry")}</h3>
          <${Sn} onClick=${e.onDelete} />
        ...
        <div class="settings-form">
          ...
          <${Oe} label=${o("settings.prod.type")} value=${t.productionType||It[0]}
            options=${It.map(function(a){return{value:a,label:o(go[a])}})}
          ...
          <${Oe} label=${o("settings.dimension")} value=${t.dimension||"W"}
            options=${Ve(vi)} onChange=${r("dimension")} />
          <${Oe} label=${o("settings.integration")} value=${i}
      ...
      </div>`}function Co(e){var t=e.item,n=gi(t);function r(l){return function(s){e.patch(l,s)}}var i=t.integration||"simulator",a=t.id==="to"?o("settings.grid.to"):o("settings.grid.from");return u`
      <div>
        <div class="md-detail-head">
      ...
      <//>`}function So(e){var t=e.tariffs,n=yo(t);function r(g){return function(b){e.patch(g,b)}}var i=Array.isArray(t.ht_windows)?t.ht_windows:[];function a(g,b,$){var y=i.map(function(m,w){if(w!==g)return m;var M=Object.assign({},m);return M[b]=$,M});e.setWindows(y)}function l(){e.setWindows(i.concat([{days:"mo-fr",from:6,to:21}]))}function s(g){e.setWindows(i.filter(function(b,$){return $!==g}))}var f=$e(t.grid_import_ht_chf_kwh)&&$e(t.grid_import_nt_chf_kwh),c=f&&i.length===0,d=Mo(t),h=Gr(d),v=Number(t.vzev_import_chf_kwh),p=h!==null&&!isNaN(v)&&v>h;return u`
      <${W} group="vzev">
        ...
        ${i.map(function(g,b){return u`
            <div key=${b} class="settings-form ht-window-row">
              <${H} label=${o("settings.tariff.win_days")} value=${g.days}
                placeholder=${o("settings.tariff.win_days.ph")} onInput=${function($){a(b,"days",$)}} />
      ...
      <//>`:u`<${W} group="vzev"><p class="placeholder-text">${o("settings.loading")}</p><//>`}function _r(e){var t={};return["ssid1","password1","ssid2","password2"].forEach(function(n){!ie(e[n])&&String(e[n]).indexOf(";")>=0&&(t[n]="settings.err.wifi_semicolon")}),t}function To(e){var t=e.net,n=t.RSSI!==void 0?t.RSSI+"%":t.Signal!==void 0?t.Signal+" dBm":"";return u`
      ...
      </div>`}function Io(){var e=x(null),t=e[0],n=e[1],r=x(!1),i=r[0],a=r[1],l=x(!1),s=l[0],f=l[1],c=x(!1),d=c[0],h=c[1],v=x({scanning:!1,networks:null,error:!1}),p=v[0],g=v[1];function b(){a(!1),n(null),F.getWifiConfig().then(function(I){n({ssid1:I.ssid1,password1:"",ssid2:I.ssid2,password2:""})}).catch(function(){a(!0)})}J(function(){b()},[]);function $(I){return function(U){n(function(N){var O=Object.assign({},N);return O[I]=U,O})}}function y(){d||!window.confirm(o("settings.gplug.restart_confirm"))||(h(!0),F.restartDevice().then(function(){le(o("settings.gplug.restart_success"),{type:"info"})}).catch(function(){le(o("settings.gplug.restart_error"),{type:"error"})}).then(function(){h(!1)}))}function m(){s||!t||rt(_r(t))||(f(!0),F.setWifiConfig(t).then(function(){le(o("settings.gplug.wifi_saved"),{type:"info"})}).catch(function(I){le(I&&I.message||o("settings.save_error"),{type:"error"})}).then(function(){f(!1)}))}function w(){g({scanning:!0,networks:null,error:!1}),F.wifiScanStart().catch(function(){});var I=0;function U(){I+=1,F.wifiScanResult().then(function(N){var O=N&&(N.WiFiScan!==void 0?N.WiFiScan:N.WifiScan);if(O&&typeof O=="object"){var C=Object.keys(O).map(function(E){return O[E]});C.sort(function(E,T){return(Number(T.RSSI)||0)-(Number(E.RSSI)||0)}),g({scanning:!1,networks:C,error:!1});return}if(I>=10){g({scanning:!1,networks:null,error:!0});return}setTimeout(U,1e3)}).catch(function(){g({scanning:!1,networks:null,error:!0})})}setTimeout(U,1e3)}function M(I,U){n(function(N){var O=Object.assign({},N);return O["ssid"+I]=U,O})}if(i)return u`
        <${W} group="grid">
          <p class="placeholder-text">${o("settings.load_error")}</p>
          <${Y} secondary small onClick=${b}>${o("settings.retry")}<//>
        <//>`;if(!t)return u`<${W} group="grid"><p class="placeholder-text">${o("settings.loading")}</p><//>`;var z=_r(t);return u`
      <div>
        <${W} group="grid" title=${o("settings.gplug.restart_title")}>
        ...
        <${W} group="grid" title=${o("settings.gplug.wifi_title")}>
      ...
      </div>`}function Eo(e){try{return JSON.stringify(JSON.parse(e),null,2)}catch{return e}}function Po(e){var t=x(null),n=t[0],r=t[1],i=x(!1),a=i[0],l=i[1],s=x(!1),f=s[0],c=s[1];function d(){l(!1),r(null),F.getConfigRaw().then(function(p){r(Eo(p))}).catch(function(){l(!0)})}J(function(){d()},[]);var h=null;if(n!==null)try{JSON.parse(n)}catch(p){h=p.message}function v(){if(!(f||h)){var p;try{p=JSON.parse(n)}catch{return}c(!0),F.postConfig(p).then(function(){le(o("settings.saved"),{type:"info"}),e.onSaved&&e.onSaved(),d()}).catch(function(g){le(g&&g.message||o("settings.save_error"),{type:"error"})}).then(function(){c(!1)})}}return a?u`
        <${W} group="grid">
          <p class="placeholder-text">${o("settings.load_error")}</p>
          <${Y} secondary small onClick=${d}>${o("settings.retry")}<//>
        <//>`:n===null?u`<${W} group="grid"><p class="placeholder-text">${o("settings.loading")}</p><//>`:u`
      <${W} group="grid">
