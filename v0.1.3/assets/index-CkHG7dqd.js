...
`||r==="\r"?(v(),a=2):o+=r),a===3&&o==="!--"&&(a=4,c=c[0])}return v(),c})(e)),t),arguments,[])).length>1?t:t[0]}const u=ga.bind(ei);var pt={},fi="de",gr={};function s(e,t){var n=pt[e];return n===void 0?(gr[e]||(gr[e]=!0,console.warn('i18n: missing key "'+e+'"')),e):(t&&(n=n.replace(/\{(\w+)\}/g,function(r,i){return t[i]!==void 0?String(t[i]):r})),n)}function ha(e){var t=0;function n(){if(t>=e.length)return Promise.reject(new Error("i18n: no language file reachable"));var r=e[t++];return fetch(r).then(function(i){if(!i.ok)throw new Error("HTTP "+i.status);return i.json()}).then(function(i){return pt=i||{},fi=pt["meta.lang"]||document.documentElement.lang||"de",pt}).catch(function(){return n()})}return n()}const ma={t:s,load:ha,getLang:function(){return fi},getDict:function(){return pt}};var $t=" ",vi="−";function Xe(e,t){if(e==null||isNaN(e))return"–";var n=e<0,r=Math.abs(Number(e)).toFixed(t),i=r.split(".");return i[0]=i[0].replace(/\B(?=(\d{3})+(?!\d))/g,"'"),r=i.join("."),(n?vi:"")+r}function $a(e){return e.indexOf(".")>=0?e.replace(/\.?0+$/,""):e}function _a(e){return e==null||isNaN(e)?"–":Math.abs(e)>=1e3?$a(Xe(e/1e3,1))+$t+"kW":Xe(Math.round(e),0)+$t+"W"}function ba(e){return e==null||isNaN(e)?"–":Math.abs(e)>=1e3?Xe(e/1e3,2)+$t+"kWh":Xe(Math.round(e),0)+$t+"Wh"}function ya(e,t){if(e==null||isNaN(e))return"–";var n=Xe(e,2);return t&&e>0&&(n="+"+n),n+$t+"CHF"}function Ae(e){return(e<10?"0":"")+e}function wa(e,t){if(e==null)return"–";var n=new Date(e*1e3),r=Ae(n.getDate())+"."+Ae(n.getMonth()+1)+"."+n.getFullYear(),i=Ae(n.getHours())+":"+Ae(n.getMinutes());switch(t){case"1d":return r;case"dm":return Ae(n.getDate())+"."+Ae(n.getMonth()+1)+".";case"1mo":return Ae(n.getMonth()+1)+"."+n.getFullYear();case"q":return n.getFullYear()+" Q"+(Math.floor(n.getMonth()/3)+1);case"hm":return i;case"15m":default:return r+" "+i}}const S={num:Xe,w:_a,wh:ba,chf:ya,time:wa,MINUS:vi};function Qe(e){return u`
      ...
      </div>`}function Xt(e){var t=Ne(null),n=gi(t),r=T(null),i=r[0],a=r[1],o=e.height||180,l=e.series||[],c=e.timeWindow;if(!c){var v=1/0,f=-1/0;l.forEach(function(y){y.points.forEach(function(R){R.t<v&&(v=R.t),R.t>f&&(f=R.t)})}),c=v===1/0?[0,1]:[v,f]}var p=c[0],d=c[1]>c[0]?c[1]:c[0]+1,h=[];l.forEach(function(y){y.points.forEach(function(R){h.push(R.y)})});var g=mi(h,!1),b=Math.max(10,n-z.left-z.right),$=o-z.top-z.bottom;function M(y){return z.left+(y-p)/(d-p)*b}function _(y){return z.top+(1-(y-g[0])/(g[1]-g[0]))*$}var O=hi(g[0],g[1],4),D=e.xTickFormat||function(y){return S.time(y,"hm")},N=Ca(p,d,Math.max(2,Math.min(5,Math.floor(b/90)))).map(function(y){return{x:M(y),label:D(y)}});function k(y){var R=[],B=[];y.forEach(function(K){K.y===null||K.y===void 0?(B.length&&R.push(B),B=[]):B.push(K)}),B.length&&R.push(B);var q=_(Math.max(0,g[0]));return R.map(function(K){var m=K.map(function(P,I){return(I===0?"M":"L")+M(P.t).toFixed(1)+" "+_(P.y).toFixed(1)}).join(""),C=m+"L"+M(K[K.length-1].t).toFixed(1)+" "+q.toFixed(1)+"L"+M(K[0].t).toFixed(1)+" "+q.toFixed(1)+"Z";return{line:m,area:C}})}function H(y){if(t.current){var R=t.current.getBoundingClientRect(),B=y.clientX-R.left;if(B<z.left||B>n-z.right){a(null);return}var q=p+(B-z.left)/b*(d-p);a(q)}}var x=null,A=[];return i!==null&&(A.push({text:D(i)}),l.forEach(function(y){var R=hr(y.points,i);R>=0&&(x===null&&(x=M(y.points[R].t)),A.push({color:y.color,text:(y.label?y.label+": ":"")+(e.yFormat||Rn)(y.points[R].y)+(e.yFormat?"":" "+e.yUnit)}))}),x===null&&(x=M(i))),u`
      <div class="chart" ref=${t}
        ...
        ${n>0?u`
          ...
          ${x!==null?_i(t,n,x,A):null}`:null}
      </div>`}function bi(e){var t=Ne(null),n=gi(t),r=T(null),i=r[0],a=r[1],o=e.height||180,l=e.points||[];function c(m){if(!m.bars)return[m.y];var C=[];return m.bars.forEach(function(P){Na(P).forEach(function(I){C.push(I)})}),C}var v=l.reduce(function(m,C){return C.bars?Math.max(m,C.bars.length):m},1),f=[];l.forEach(function(m){c(m).forEach(function(C){f.push(C)})});var p=mi(f,!0),d=Math.max(10,n-z.left-z.right),h=o-z.top-z.bottom;function g(m){return z.top+(1-(m-p[0])/(p[1]-p[0]))*h}var b=l.length,$=b>0?d/b:d;function M(m){return z.left+(m+.5)*$}var _=Math.max(1,Math.min($-1,$*.72,46)),O=hi(p[0],p[1],4),D=e.xTickFormat||function(m){return S.time(m,"hm")},N=Ma(l,d,D).map(function(m){return{x:M(m),label:D(l[m].t)}}),k=g(0),H=l.length+"|"+(l.length?l[0].t+"-"+l[l.length-1].t:"")+"|"+v+"|"+(e.yUnit||"");function x(m){if(!t.current||!b){a(null);return}var C=t.current.getBoundingClientRect(),P=m.clientX-C.left;if(P<z.left||P>n-z.right){a(null);return}var I=Math.floor((P-z.left)/$);a(I<0?0:I>=b?b-1:I)}var A=e.yFormat||Rn;function y(m){return A(m)+(e.yFormat?"":" "+(e.yUnit||""))}var R=null,B=[];if(i!==null&&l[i]){var q=l[i];if(R=M(i),B.push({text:D(q.t)}),q.bars)q.bars.forEach(function(m){(m.segments||[]).forEach(function(C){if(C.value){var P=e.signedMagnitude?Math.abs(C.value):C.value;B.push({color:C.color,text:(C.label?C.label+": ":"")+y(P)})}})});else if(q.y!==null&&q.y!==void 0){var K=e.signedMagnitude?Math.abs(q.y):q.y;B.push({color:q.color||e.color,text:(q.label?q.label+": ":"")+y(K)})}}return u`
      <div class="chart" ref=${t}
        onPointerMove=${x}
        onPointerLeave=${function(){a(null)}}>
        ${n>0?u`
          <svg width=${n} height=${o} role="img" aria-label=${e.label||""}>
            ...
            ${l.map(function(m,C){var P=i===C?"1":"0.85";if(m.bars){var I=M(C)-_/2,we=_/v;return u`<g key=${C}>${m.bars.map(function(rt,Fe){var Be=I+Fe*we+1,me=Math.max(1,we-2),ke=0,le=0;return(rt.segments||[]).map(function(E,re){var V=E.value||0;if(!V)return null;var ee,ve;V>0?(ee=ke,ve=ke+V,ke=ve):(ee=le,ve=le+V,le=ve);var it=Math.min(g(ee),g(ve)),xe=Math.max(1,Math.abs(g(ve)-g(ee)));return u`
                      <rect key=${Fe+"-"+re}
                        class=${"ch-bar "+(V>0?"ch-bar-up":"ch-bar-down")}
                        x=${Be.toFixed(1)} y=${it.toFixed(1)}
                        width=${me.toFixed(1)} height=${xe.toFixed(1)} rx="1.5"
                        fill=${E.color} opacity=${P}/>`})})}</g>`}if(m.y===null||m.y===void 0)return null;var ge=M(C)-_/2,he=g(m.y),ce=Math.min(he,k),nt=Math.max(1,Math.abs(he-k));return u`
      ...
      </div>`}var Ia=[10,25,50];function Pa(e){var t=T(0),n=t[0],r=t[1],i=T(e.pageSize||10),a=i[0],o=i[1],l=e.rows||[],c=l.length,v=Math.max(1,Math.ceil(c/a)),f=Math.min(n,v-1),p=f*a,d=Math.min(p+a,c),h=l.slice(p,d);return u`
...
`){c(),o++;continue}i+=v,o++}return(i!==""||r.length)&&c(),n}function Ei(e,t){var n=[$r(e)];return(t||[]).forEach(function(r){n.push($r(r))}),Fa+n.join(mr)+mr}function Ua(e,t){var n=new Date;function r(a){return(a<10?"0":"")+a}var i=n.getFullYear()+r(n.getMonth()+1)+r(n.getDate());return"gplug-verlauf-"+e+"-"+i+".csv"}var Wn="gplug-archive",ja=3,gt=900,_r=384,Ha=60,Ka=2*86400,za=50,qa="2",Ya=["1","2"],br={},yr=!1,He=null,wn=!1;function Ga(){return typeof indexedDB<"u"?indexedDB:typeof globalThis<"u"?globalThis.indexedDB:void 0}function et(e){return new Promise(function(t,n){e.onsuccess=function(){t(e.result)},e.onerror=function(){n(e.error||new Error("idb request failed"))}})}function Un(e){return new Promise(function(t,n){e.oncomplete=function(){t()},e.onabort=e.onerror=function(){n(e.error||new Error("idb tx failed"))}})}function ye(){if(He)return He;var e=Ga();return e?(He=new Promise(function(t,n){var r;try{r=e.open(Wn,ja)}catch(i){n(i);return}r.onupgradeneeded=function(){var i=r.result;i.objectStoreNames.contains("e15")||i.createObjectStore("e15",{keyPath:["siteId","ts"]}),i.objectStoreNames.contains("vz15")&&i.deleteObjectStore("vz15"),i.objectStoreNames.contains("meta")||i.createObjectStore("meta",{keyPath:"siteId"}),i.objectStoreNames.contains("live")||i.createObjectStore("live",{keyPath:["siteId","kind","id"]})},r.onsuccess=function(){var i=r.result;i.onversionchange=function(){i.close(),He=null},t(i)},r.onerror=function(){n(r.error||new Error("idb open failed"))},r.onblocked=function(){n(new Error("idb blocked"))}}).catch(function(t){throw wn=!0,He=null,t}),He):(wn=!0,Promise.reject(new Error("IndexedDB unavailable")))}function Va(){return wn?Promise.resolve(!1):ye().then(function(){return!0},function(){return!1})}function tt(e,t,n){return e.transaction(t,n).objectStore(t)}function Za(e){return{siteId:e,firstE15Ts:null,lastE15Ts:null,gaps:[],count:0,syncedAt:null}}function jn(e){return ye().then(function(t){return et(tt(t,"meta","readonly").get(e))}).then(function(t){return t||Za(e)})}function Ti(e){return ye().then(function(t){var n=t.transaction("meta","readwrite");return n.objectStore("meta").put(e),Un(n).then(function(){return e})})}function Xa(){return ye().then(function(e){return et(tt(e,"meta","readonly").getAllKeys())}).then(function(e){return(e||[]).map(String)})}function Hn(e,t,n){var r=t??0,i=n??9999999999;return IDBKeyRange.bound([e,r],[e,i])}function Ja(e,t,n){return ye().then(function(r){return et(tt(r,"e15","readonly").getAll(Hn(e,t,n)))}).then(function(r){return(r||[]).map(function(i){var a={ts:i.ts,imp_wh:i.imp_wh,exp_wh:i.exp_wh,pv_wh:i.pv_wh};return Kn(a,i),i.partial&&(a.partial=!0),a})})}function Ii(e,t){return!t||!t.length?Promise.resolve(0):ye().then(function(n){var r=n.transaction("e15","readwrite"),i=r.objectStore("e15"),a=0;return t.forEach(function(o){if(!(!o||typeof o.ts!="number")){var l={siteId:e,ts:o.ts,imp_wh:ht(o.imp_wh),exp_wh:ht(o.exp_wh),pv_wh:ht(o.pv_wh)};Kn(l,o),o.partial&&(l.partial=!0),i.put(l),a++}}),Un(r).then(function(){return a})})}function ht(e){return e==null||isNaN(e)?null:Number(e)}var Qa=["bat_chg_wh","bat_dis_wh"];function Kn(e,t){Qa.forEach(function(n){var r=ht(t[n]);r!==null&&(e[n]=r)})}function es(e){for(var t=[],n=1;n<e.length;n++){var r=e[n-1],i=e[n];if(i-r>gt&&(t.push([r+gt,i-gt]),t.length>=za))break}return t}function zn(e){return ye().then(function(t){return et(tt(t,"e15","readonly").getAllKeys(Hn(e)))}).then(function(t){var n=(t||[]).map(function(r){return r[1]});return n.sort(function(r,i){return r-i}),{count:n.length,firstE15Ts:n.length?n[0]:null,lastE15Ts:n.length?n[n.length-1]:null,gaps:es(n)}})}function qn(e){return Promise.all([jn(e),zn(e),ts()]).then(function(t){var n=t[0],r=t[1];return{siteId:e,firstE15Ts:r.firstE15Ts,lastE15Ts:r.lastE15Ts,count:r.count,gaps:r.gaps,syncedAt:n.syncedAt,days:r.firstE15Ts===null?0:Math.max(1,Math.round((r.lastE15Ts-r.firstE15Ts)/86400)),estimate:t[2]}})}function ts(){return typeof navigator>"u"||!navigator.storage||!navigator.storage.estimate?Promise.resolve(null):navigator.storage.estimate().then(function(e){return e},function(){return null})}function ns(){return yr||(yr=!0,typeof navigator>"u"||!navigator.storage||!navigator.storage.persist)?Promise.resolve(null):navigator.storage.persist().then(function(e){return e},function(){return null})}function rs(e,t){var n;return jn(t).then(function(r){n=r;var i=0;return r.lastE15Ts!==null&&r.lastE15Ts!==void 0&&(i=r.lastE15Ts+gt,br[t]||(i=Math.max(0,r.lastE15Ts-Ka))),br[t]=!0,is(e,t,i)}).then(function(){return zn(t)}).then(function(r){return n.firstE15Ts=r.firstE15Ts,n.lastE15Ts=r.lastE15Ts,n.count=r.count,n.gaps=r.gaps,n.syncedAt=Math.floor(Date.now()/1e3),Ti(n)}).then(function(){return ns()}).then(function(){return qn(t)})}function is(e,t,n){var r=0;function i(a){return r>=Ha?Promise.resolve():(r++,e.getEnergy("15m",_r,a).then(function(o){return!Array.isArray(o)||!o.length?null:Ii(t,o).then(function(){var l=o[o.length-1].ts;return o.forEach(function(c){c.ts>l&&(l=c.ts)}),o.length<_r?null:i(l+gt)})}))}return i(n)}function as(e){return IDBKeyRange.bound([e,"",""],[e,"￿","￿"])}function wr(e,t,n){var r=Object.keys(n||{});return!e||!r.length?Promise.resolve(0):ye().then(function(i){var a=i.transaction("live","readwrite"),o=a.objectStore("live");return r.forEach(function(l){for(var c=n[l]||[],v=[],f=0;f<c.length;f++)v.push(c[f].t,ht(c[f].y));o.put({siteId:e,kind:t,id:String(l),pts:v})}),Un(a).then(function(){return r.length})})}function kr(e,t,n){var r=n??0;return ye().then(function(i){return et(tt(i,"live","readonly").getAll(as(e)))}).then(function(i){var a={};return(i||[]).forEach(function(o){if(!(!o||o.kind!==t||!Array.isArray(o.pts))){for(var l=[],c=0;c+1<o.pts.length;c+=2)o.pts[c]<r||l.push({t:o.pts[c],y:o.pts[c+1]});l.length&&(a[o.id]=l)}}),a})}function ss(e){return ye().then(function(t){return et(tt(t,"e15","readonly").getAll(Hn(e)))}).then(function(t){var n=[];return(t||[]).sort(function(r,i){return r.ts-i.ts}).forEach(function(r){n.push(["e",r.ts,st(r.imp_wh),st(r.exp_wh),st(r.pv_wh),r.partial?"1":"0",st(r.bat_chg_wh),st(r.bat_dis_wh)])}),Ei([Wn,qa,e],n)})}function st(e){return e==null?"":String(e)}function os(e,t){var n=Wa(e);if(!n.length||n[0][0]!==Wn)return Promise.reject(new Error("not a gplug archive export"));if(Ya.indexOf(n[0][1])<0)return Promise.reject(new Error("unsupported export format "+n[0][1]));var r=n[0][2];if(t&&r!==t)return Promise.reject(new Error("site mismatch: file "+r+", device "+t));for(var i=t||r,a=[],o=1;o<n.length;o++){var l=n[o];if(!(!l||!l.length)&&l[0]==="e"){var c={ts:Number(l[1]),imp_wh:ot(l[2]),exp_wh:ot(l[3]),pv_wh:ot(l[4])};l[5]==="1"&&(c.partial=!0),Kn(c,{bat_chg_wh:ot(l[6]),bat_dis_wh:ot(l[7])}),a.push(c)}}return Ii(i,a).then(function(){return zn(i)}).then(function(v){return jn(i).then(function(f){return f.firstE15Ts=v.firstE15Ts,f.lastE15Ts=v.lastE15Ts,f.count=v.count,f.gaps=v.gaps,Ti(f)})}).then(function(){return qn(i)})}function ot(e){return e===""||e===void 0?null:Number(e)}var ls=900*1e3,Z={available:null,siteId:null,coverage:null,error:null,syncing:!1,otherSites:[]},Ut=[],dt=null,xr=null;function Pi(){return Z}function jt(){Ut.forEach(function(e){try{e(Z)}catch{}})}function Oi(e){return Ut.push(e),function(){var t=Ut.indexOf(e);t>=0&&Ut.splice(t,1)}}function us(e){return dt||(dt=Va().then(function(t){return Z.available=t,t?e.getSite().then(function(n){return Z.siteId=n&&n.id?String(n.id):null,Z.siteId?Xa().then(function(r){Z.otherSites=r.filter(function(i){return i!==Z.siteId})},function(){}).then(function(){return kn(e)}).then(function(){return xr===null&&typeof setInterval=="function"&&(xr=setInterval(function(){kn(e)},ls)),Z}):(jt(),Z)},function(){return jt(),Z}):(jt(),Z)}),dt)}function kn(e){return!Z.available||!Z.siteId||Z.syncing?Promise.resolve(Z):(Z.syncing=!0,rs(e,Z.siteId).then(function(t){Z.coverage=t,Z.error=null},function(t){Z.error=t&&t.message?t.message:"sync failed"}).then(function(){return Z.syncing=!1,jt(),Z}))}function Jt(){return dt||Promise.resolve(Z)}function cs(e){return kn(e)}var Ai={overview:u`<svg viewBox="0 0 20 20" class="nav-icon" aria-hidden="true"><rect x="2.5" y="2.5" width="6" height="6" rx="1.5" fill="currentColor"/><rect x="11.5" y="2.5" width="6" height="6" rx="1.5" fill="currentColor"/><rect x="2.5" y="11.5" width="6" height="6" rx="1.5" fill="currentColor"/><rect x="11.5" y="11.5" width="6" height="6" rx="1.5" fill="currentColor"/></svg>`,history:u`<svg viewBox="0 0 20 20" class="nav-icon" aria-hidden="true"><path d="M3 3v13.5h14" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/><path d="M5.5 12.5l3.5-4 3 2.5 4.5-5.5" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/></svg>`,meter:u`<svg viewBox="0 0 20 20" class="nav-icon" aria-hidden="true"><circle cx="10" cy="10" r="7.5" fill="none" stroke="currentColor" stroke-width="1.6"/><path d="M10 10l3.5-2.5" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"/><path d="M4.2 11.5h1.6M14.2 11.5h1.6M10 4.2v1.4" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"/></svg>`,modbus:u`<svg viewBox="0 0 20 20" class="nav-icon" aria-hidden="true"><rect x="3.5" y="6" width="13" height="8" rx="1.5" fill="none" stroke="currentColor" stroke-width="1.6"/><path d="M6.5 6V3.8M10 6V3.8M13.5 6V3.8M6.5 14v2.2M10 14v2.2M13.5 14v2.2" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"/></svg>`,settings:u`<svg width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    `,burger:u`<svg viewBox="0 0 20 20" class="nav-icon" aria-hidden="true"><path d="M3 5h14M3 10h14M3 15h14" stroke="currentColor" stroke-width="2" stroke-linecap="round"/></svg>`};function Sr(){return u`
      ...
      </nav>`}function fs(e){var t=wi.useRoute(e.routes),n=T(!1),r=n[0],i=n[1],a=T(!1),o=a[0],l=a[1],c=T(null),v=c[0],f=c[1],p=T(!1),d=p[0],h=p[1],g=T(!1),b=g[0],$=g[1];Q(function(){return U.onStatus(function(_,O){_?f(null):(ne(s("error.offline"),{type:"error"}),f(O?new Date(O):new Date))})},[]),Q(function(){var _=!1;function O(N){!_&&N.otherSites&&N.otherSites.length&&(_=!0,ne(s("banner.archive_site_changed",{id:N.siteId}),{type:"warn"}))}var D=Oi(O);return Jt().then(O),D},[]),Q(function(){return U.poll(function(){U.getMeta().then(function(_){l(!!_&&typeof _.time=="number"&&_.time<1e9)}).catch(function(){})},6e4)},[]),Q(function(){U.getMeter().then(function(_){h(!!(_&&_.values))}).catch(function(){})},[]),Q(function(){U.getModbus().then(function(_){$(Array.isArray(_)&&_.length>0)}).catch(function(){})},[]),Q(function(){i(!1)},[t.path]);var M=t.route.component;return u`
      <div class="shell">
        <aside class="sidebar">
          <${Sr} />
          <${Cr} path=${t.path} showMeter=${d} showModbus=${b} />
          <div class="sidebar-foot">${"v0.1.3"}</div>
        </aside>
      ...
      </div>`}var Vs={"comp.grid":"←"},Zs={"comp.feedin":"→"};function Xs(e){var t=T("now"),n=t[0],r=t[1],i=n==="now"?Es(e.sample):Ts(e.records),a=n==="now"?S.w:S.wh,o=n==="today"&&e.hasBattery&&!i.battery&&!i.unknown?s("flow.comp_batt_note"):null;return u`
      <div class="comp-wrap">
...
`):s("tooltip.kpi_saving"),a=!!e.showSaving,o=a?u`
      ...
      </div>`}function to(e){return e==null||isNaN(e)?"–":e>=1e3?S.num(e/1e3,2)+" t":S.num(e,e<10?2:1)+" kg"}function no(){var e=T(null),t=e[0],n=e[1],r=T(null),i=r[0],a=r[1],o=T([]),l=o[0],c=o[1],v=T([]),f=v[0],p=v[1],d=T(null),h=d[0],g=d[1],b=T(null),$=b[0],M=b[1],_=T(function(){return Math.floor(Date.now()/1e3)}),O=_[0],D=_[1],N=T(null),k=N[0],H=N[1],x=T({}),A=x[0],y=x[1],R=T(!1),B=R[0],q=R[1],K=T(0),m=K[1],C=Ne({}),P=Ne({}),I=Ne(!1),we=O,ge=we-dn,he=[ge,we];Q(function(){U.getSite().then(function(j){n(j)}).catch(function(){}),U.getMeta().then(function(j){M(j)}).catch(function(){})},[]),Q(function(){var j=!0;function Se(){j&&(I.current=!0,m(function(se){return se+1}))}return Jt().then(function(se){if(j){if(!se||!se.available||!se.siteId){Se();return}var We=Math.floor(Date.now()/1e3)-dn;return Promise.all([kr(se.siteId,"prod",We).catch(function(){return{}}),kr(se.siteId,"load",We).catch(function(){return{}})]).then(function($e){j&&(Ir(C.current,$e[0]),Ir(P.current,$e[1]),Se())})}},Se).catch(Se),function(){j=!1}},[]),Q(function(){return U.poll(function(){U.getEnergy("15m",96).then(function(j){Array.isArray(j)&&g(j)}).catch(function(){})},6e4)},[]),Q(function(){return U.poll(function(){var j=Math.floor(Date.now()/1e3);D(j);var Se=j-dn;Promise.all([U.getPower().catch(function(){return null}),U.getLoads().catch(function(){return null}),U.getProductions().catch(function(){return null})]).then(function(se){var We=se[0],$e=se[1],Oe=se[2];if(We&&a(We),$e&&c($e),Oe&&p(Oe),(We||$e||Oe)&&H(j),q(!0),Oe&&Oe.forEach(function(Ue){Tr(C.current,Ue.id,j,_t(Ue),Se)}),$e&&$e.forEach(function(Ue){var ia=Fi(Ue.state)==="active"?_t(Ue):0;Tr(P.current,Ue.id,j,ia,Se)}),I.current&&(Oe||$e)){var at=Pi();at&&at.available&&at.siteId&&(Oe&&wr(at.siteId,"prod",C.current).catch(function(){}),$e&&wr(at.siteId,"load",P.current).catch(function(){}))}})},1e4)},[]);var ce=Rs(i),nt=Ui(i,ge,we),rt=!!(f&&f.length&&Is(nt.pv.map(function(j){return j.y}))&&!A["flow.prod_nodata"]);function Fe(){var j=Object.assign({},A);j["flow.prod_nodata"]=!0,y(j)}var Be=new Date;Be.setHours(0,0,0,0);var me=Math.floor(Be.getTime()/1e3),ke=(h||[]).filter(function(j){return j.ts>=me}),le=$&&$.tariffs||{},E=le.co2_g_kwh===void 0||le.co2_g_kwh===null||le.co2_g_kwh===""?128:Number(le.co2_g_kwh),re=Mn(ke,{tariffs:le,co2:E}),V=Number(le.grid_import_chf_kwh)>0||Number(le.grid_feedin_chf_kwh)>0,ee=E>0,ve=ke.some(function(j){return j.partial}),it=ve?s("kpi.today_until",{time:S.time(O,"hm")}):s("kpi.today"),xe=(f||[]).some(function(j){return String(j.productionType||"").toUpperCase()==="BATTERY"}),wt=(f||[]).some(function(j){return String(j.productionType||"").toUpperCase()!=="BATTERY"}),kt=!!(ce&&k&&O-k<25&&i&&typeof i.now=="number"&&i.now-ce.ts<Hs),xt=t&&t.location?t.location:null,an=k?u`
        ...
        ${B?u`
          <${bt}>
            ...
            <section class="ov-history" aria-labelledby="ov-sec-history">
              ...
              <${Us} loads=${l} history=${P.current} win=${he} onToggle=${sn} />
            </section>
          <//>`:u`<${eo} />`}
      ...
      </p>`}function po(){var e=T(Te.res),t=e[0],n=e[1],r=T(0),i=r[0],a=r[1],o=T(Te.pageSize),l=o[0],c=o[1],v=T(Te.chfMode),f=v[0],p=v[1],d=T(Te.chartMode),h=d[0],g=d[1],b=T({records:null,tariffs:{},producer:!1,err:!1,archived:!1,coverage:null,blocked:!1}),$=b[0],M=b[1],_=T(!0),O=_[0],D=_[1];Te.res=t,Te.pageSize=l,Te.chfMode=f,Te.chartMode=h,Q(function(){var E=!1;D(!0);var re=Me[t];return Jt().then(function(V){var ee=!!(V.available&&V.siteId),ve=Math.floor(Date.now()/1e3),it=ve-vn[t];return Promise.all([ee?Ja(V.siteId,it,ve).catch(function(){return null}):U.getEnergy("15m",re.count).catch(function(){return null}),U.getMeta().catch(function(){return null}),U.getProductions().catch(function(){return null})]).then(function(xe){if(!E){var wt=xe[0],kt=xe[1],xt=xe[2];if(wt===null){M({records:null,tariffs:{},producer:!1,err:!0,archived:!1,coverage:null,blocked:V.available===!1}),D(!1);return}var an=kt&&kt.tariffs||{},sn=Array.isArray(xt)&&xt.some(function(j){return j&&j.productionType==="PHOTOVOLTAIC"});M({records:wt,tariffs:an,producer:sn,err:!1,archived:ee,coverage:V.coverage||null,blocked:V.available===!1}),D(!1)}})}),function(){E=!0}},[t]);var N=Qt($.tariffs),k=Le(function(){if(!$.records)return[];var E=$.records;N&&(E=$.records.map(function(V){return Ri(V,$.tariffs)}));var re=Mr(E,"15m",Me[t].target,$.tariffs);return re.slice().sort(function(V,ee){return ee.ts-V.ts})},[$.records,$.tariffs,t,N]),H=Le(function(){if(t!=="15m"||!$.records)return{};var E=Mr($.records,"15m","15m",$.tariffs),re=xs(E,3),V={};return re.forEach(function(ee){V[E[ee].ts]=!0}),V},[$.records,$.tariffs,t]),x=k.some(function(E){return(E.exp_wh||0)>0}),A=k.some(function(E){return E.bat_chg_wh!=null||E.bat_dis_wh!=null}),y=uo($.producer,x,N,A),R=$.tariffs.co2_g_kwh===void 0||$.tariffs.co2_g_kwh===null||$.tariffs.co2_g_kwh===""?128:Number($.tariffs.co2_g_kwh),B={tariffs:$.tariffs,co2:R},q=Number($.tariffs.grid_import_chf_kwh)>0||Number($.tariffs.grid_feedin_chf_kwh)>0,K=Le(function(){var E={};return k.forEach(function(re){E[re.ts]=Mn([re],B)}),E},[k,$.tariffs,R]),m=Le(function(){return Mn(k,B)},[k,$.tariffs,R]),C=$.archived?!($.coverage&&$.coverage.firstE15Ts!==null&&$.coverage.firstE15Ts>Math.floor(Date.now()/1e3)-vn[t]):$.records?$.records.length<Me[t].count:!0,P=fo(k,t,C),I=k.length;P.filter(function(E){return E.kind==="row"});var we=Math.max(1,Math.ceil(I/l)),ge=Math.min(i,we-1),he=ge*l,ce=Math.min(he+l,I),nt=go(P,he,ce);function rt(E){n(E),a(0)}function Fe(E){c(+E),a(0)}function Be(){var E=y.map(function(ee){return ee.label+(ee.unit?" "+ee.unit:"")}),re=k.map(function(ee){return $o(ee,y,t,K[ee.ts])}),V=Ei(E,re);xo(Ua(t),V)}var me=Le(function(){return bo(lo(k,t),h,f)},[k,h,f,t]),ke=Le(function(){return yo(k,t,$.producer)},[k,t,$.producer]),le=u`
      <div class="verlauf-actions">
        <${pi} label=${s("history.resolution")} value=${t}
          onChange=${rt}
          options=${io.map(function(E){return{value:E,label:s(Me[E].label)}})} />
        <${Y} secondary onClick=${Be} disabled=${I===0}>
          ${s("history.export")}<//>
      </div>`;return u`
      <div>
            ...
            <${F} group="grid" title=${s("history.chart.title")}>
              <div class="chart-toolbar">
                <div class="seg-toggle" role="tablist" aria-label=${s("history.chart.mode")}>
                  ${[["net","history.chart.mode_net"],["bilanz","history.chart.mode_bilanz"]].map(function(E){return u`<button key=${E[0]} type="button" role="tab"
                      class=${"seg-btn"+(h===E[0]?" seg-btn-active":"")}
                      aria-selected=${h===E[0]}
                      onClick=${function(){g(E[0])}}>${s(E[1])}</button>`})}
                </div>
                ${h==="net"?u`
                  <label class="chf-toggle">
                    <input type="checkbox" checked=${f}
                      onChange=${function(E){p(E.target.checked)}} />
              ...
              ${me.points.length?u`
                <${bi} height=${220}
                  ...
                  xTickFormat=${function(E){return _o(t,E)}}
                  points=${me.points} />
                <div class="chart-legend">
                  ${me.legend.map(function(E,re){return u`<span key=${re} class="legend-item"><span class="legend-swatch" style=${"background:"+E.color}></span>${E.label}</span>`})}
            ...
            <${F} title=${s("history.table.title")}
              ...
              <div class="table-wrap">
                <table class="table verlauf-table">
                  <thead>
                    <tr>
                      ${y.map(function(E){return u`<th key=${E.key} class=${E.align==="right"?"ta-r":""}>
                          ${E.label}${E.unit?u`<span class="th-unit"> ${E.unit}</span>`:null}
                        </th>`})}
                    </tr>
                  </thead>
                  <tbody>
                    ${I===0?u`
                      <tr><td class="table-empty" colspan=${y.length}>${s("common.nodata")}</td></tr>`:nt.map(function(E){return ho(E,y,t,H,K)})}
                  </tbody>
                </table>
                  ...
                  <label class="table-pagesize">
                    ...
                    <span class="select-wrap select-wrap-small">
                      <select class="select select-small" value=${l}
                        onChange=${function(E){Fe(E.target.value)}}>
                        ${ro.map(function(E){return u`<option key=${E} value=${E}>${E}</option>`})}
                      </select>
                      <svg class="select-caret" viewBox="0 0 12 8" aria-hidden="true"><path d="M1 1.5 6 6.5 11 1.5" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/></svg>
                    </span>
                  </label>
                  <span class="table-pageinfo">
                    ${s("table.pageinfo",{from:I===0?0:he+1,to:ce,total:I})}
                  </span>
                  <span class="table-nav">
                    <button class="table-navbtn" aria-label=${s("table.prev")}
      ...
      <//>`}function zo(){var e=T(void 0),t=e[0],n=e[1],r=T(null),i=r[0],a=r[1],o=T(!1),l=o[0],c=o[1],v=T(null),f=v[0],p=v[1],d=Ne([]),h=Ne({u:{},peakImp:0,peakExp:0});Q(function(){return U.poll(function(){U.getMeter().then(function($){if(n($&&$.values?$.values:null),p($&&typeof $.now=="number"?$.now:Math.floor(Date.now()/1e3)),!(!$||!$.values)){var M=Dr($.values),_=h.current;[1,2,3].forEach(function(y){var R=_e(M,zi("voltage",y));R!==null&&(_.u[y]=Oo(_.u[y],R))});var O=Xn(M),D=O.net,N=_e(M,Ye("meter.f.power_import")),k=_e(M,Ye("meter.f.power_export"));N!==null&&(N=N*O.scale),k!==null&&(k=k*O.scale),N===null&&D!==null&&(N=D>0?D:0),k===null&&D!==null&&(k=D<0?-D:0),N!==null&&(_.peakImp=Rr(_.peakImp,N)),k!==null&&(_.peakExp=Rr(_.peakExp,k)),a({u:Object.assign({},_.u),peakImp:_.peakImp,peakExp:_.peakExp});var H=_e(M,Ye("meter.f.energy_import")),x=D!==null?D>0:N!==null&&N>0,A=d.current;for(A.push({reg:H,importing:x});A.length>Lo;)A.shift();c(Po(A))}}).catch(function(){})},Ao)},[]);var g=t?Dr(t):[],b=f?Math.max(0,Math.floor(Date.now()/1e3)-f):null;return u`
      <div>
      ...
      <//>`}function Vo(){var e=T(void 0),t=e[0],n=e[1],r=T(null),i=r[0],a=r[1];Q(function(){return U.poll(function(){U.getModbus().then(function(l){n(Array.isArray(l)?l:[]),a(Math.floor(Date.now()/1e3))}).catch(function(){})},qo)},[]);var o=i?Math.max(0,Math.floor(Date.now()/1e3)-i):null;return u`
      <div>
      ...
      <${w} label=${s("settings.modbus.write_inactive")} type="number" step="any" value=${r.inactive}
        error=${n["write.inactive"]} onInput=${i("inactive")} />`}var yl={1:"Illegal function",2:"Illegal data address",3:"Illegal data value",4:"Server device failure",10:"Gateway path unavailable",11:"Gateway target failed to respond"};function wl(e){return"0x"+("0000"+Number(e).toString(16).toUpperCase()).slice(-4)}function kl(e){var t=gl(e.cfg),[n,r]=T({mode:t.length?"item":"free",target:0,url:"",unit:"",function:"3",register:"",dtype:"float32",swap_words:!1,scale:"",dimension:"W",wfunction:"",value:""}),[i,a]=T(!1),[o,l]=T(!1),[c,v]=T(null);function f(x){return function(A){var y=Object.assign({},n);y[x]=A,r(y),l(!1)}}var p=t[Number(n.target)]||t[0],d=n.mode==="item"&&!!p,h=d?"item":"free",g=Object.assign({},n,{mode:h}),b=zr(g,!1),$=zr(g,!0),M=d?p.writable:!0,_=String(d?p.register:n.register);function O(x,A){v(Object.assign({kind:A},x||{}))}function D(x){v({error:x&&x.message||String(x)})}function N(){a(!0),l(!1),U.modbusRead(hl(g,p)).then(function(x){O(x,"read")},D).then(function(){a(!1)})}function k(){a(!0),l(!1),U.modbusWrite(ml(g,p)).then(function(x){O(x,"write")},D).then(function(){a(!1)})}var H=[{value:"item",label:s("settings.modbus.test.mode_item")},{value:"free",label:s("settings.modbus.test.mode_free")}];return u`
        ...
        <div class="settings-form">
          ...
          ${d?u`
            <${X} label=${s("settings.modbus.test.target")} value=${String(n.target)}
              options=${t.map(function(x,A){return{value:String(A),label:x.name+" · "+s("settings.modbus.test.field."+x.field)+" · "+x.register}})}
              onChange=${f("target")} />`:u`
      ...
      </div>`}function Tl(){var e=T(null),t=e[0],n=e[1],r=T(!1),i=r[0],a=r[1],o=T(!1),l=o[0],c=o[1],v=T(!1),f=v[0],p=v[1],d=T({scanning:!1,networks:null,error:!1}),h=d[0],g=d[1];function b(){a(!1),n(null),U.getWifiConfig().then(function(k){n({ssid1:k.ssid1,password1:"",ssid2:k.ssid2,password2:""})}).catch(function(){a(!0)})}Q(function(){b()},[]);function $(k){return function(H){n(function(x){var A=Object.assign({},x);return A[k]=H,A})}}function M(){f||!window.confirm(s("settings.gplug.restart_confirm"))||(p(!0),U.restartDevice().then(function(){ne(s("settings.gplug.restart_success"),{type:"info"})}).catch(function(){ne(s("settings.gplug.restart_error"),{type:"error"})}).then(function(){p(!1)}))}function _(){l||!t||De(Yr(t))||(c(!0),U.setWifiConfig(t).then(function(){ne(s("settings.gplug.wifi_saved"),{type:"info"})}).catch(function(k){ne(k&&k.message||s("settings.save_error"),{type:"error"})}).then(function(){c(!1)}))}function O(){g({scanning:!0,networks:null,error:!1}),U.wifiScanStart().catch(function(){});var k=0;function H(){k+=1,U.wifiScanResult().then(function(x){var A=x&&(x.WiFiScan!==void 0?x.WiFiScan:x.WifiScan);if(A&&typeof A=="object"){var y=Object.keys(A).map(function(R){return A[R]});y.sort(function(R,B){return(Number(B.RSSI)||0)-(Number(R.RSSI)||0)}),g({scanning:!1,networks:y,error:!1});return}if(k>=10){g({scanning:!1,networks:null,error:!0});return}setTimeout(H,1e3)}).catch(function(){g({scanning:!1,networks:null,error:!0})})}setTimeout(H,1e3)}function D(k,H){n(function(x){var A=Object.assign({},x);return A["ssid"+k]=H,A})}if(i)return u`
        <${F} group="grid">
      ...
      <div>
        ...
        <${F} group="grid" title=${s("settings.gplug.wifi_title")}>
          ...
          <${Y} secondary small disabled=${h.scanning} onClick=${O}>
      ...
      <${F} group="grid">
      ...
      <//>`}function Ll(){return{id:"",friendlyName:"",loadType:En[0],currentPower:"",priority:1,integration:"simulator",url:""}}function Rl(){return{id:"",friendlyName:"",productionType:Gt[0],dimension:"W",integration:"simulator",url:""}}function Dl(){return{id:"",friendlyName:"",integration:"modbustcp",url:"",unit:1,function:3,register:"",dtype:"float32"}}function Fl(e){var t=e.params&&e.params.tab||"site",n=Xo[t]||"site",r=T(null),i=r[0],a=r[1],o=T(null),l=o[0],c=o[1],v=T(!1),f=v[0],p=v[1],d=T(!1),h=d[0],g=d[1],b=T({loads:[],productions:[],grid:[],modbusRegisters:[]}),$=b[0],M=b[1];function _(m){return(Array.isArray(m)?m:[]).map(function(C){return String(C&&C.id)}).filter(function(C){return!L(C)})}function O(){c(null),U.getConfig().then(function(m){a(D(m)),g(!L(m&&m.id)),M({loads:_(m&&m.loads),productions:_(m&&m.productions),grid:_(m&&m.grid),modbusRegisters:_(m&&m.modbusRegisters)})}).catch(function(){c(!0),a(null)})}Q(function(){O()},[]);function D(m){m=m||{};var C=Object.assign({},m);return C.loads=Array.isArray(m.loads)?m.loads:[],C.productions=Array.isArray(m.productions)?m.productions:[],C.grid=Array.isArray(m.grid)?m.grid:[],C.modbusRegisters=Array.isArray(m.modbusRegisters)?m.modbusRegisters:[],C.tariffs=Object.assign({},rl,m.tariffs||{}),C}function N(m,C){a(function(P){var I=Object.assign({},P);return I[m]=C,I})}function k(m,C){a(function(P){var I=Object.assign({},P);return I.tariffs=Object.assign({},P.tariffs),I.tariffs[m]=C,I})}function H(m){a(function(C){var P=Object.assign({},C);return P.tariffs=Object.assign({},C.tariffs),P.tariffs.ht_windows=m,P})}function x(m,C){a(function(P){var I=Object.assign({},P);return I[m]=C,I})}function A(){f||(p(!0),U.postConfig(y(i)).then(function(){ne(s("settings.saved"),{type:"info"}),g(!0),O()}).catch(function(m){ne(m&&m.message||s("settings.save_error"),{type:"error"})}).then(function(){p(!1)}))}function y(m){var C=Object.assign({},m);return C.loads=m.loads.map(function(P){var I=Object.assign({},P);return I.currentPower!==""&&I.currentPower!==void 0&&(I.currentPower=Number(I.currentPower)),I.priority!==""&&I.priority!==void 0&&(I.priority=Number(I.priority)),pn(I)}),C.productions=m.productions.map(function(P){return pn(Ur(P))}),C.grid=m.grid.map(function(P){return pn(Ur(P))}),C.modbusRegisters=m.modbusRegisters.map(function(P){var I=Object.assign({},P);return I.function=Number(I.function||3),I.register=Number(I.register),L(I.unit)?delete I.unit:I.unit=Number(I.unit),L(I.scale)||Number(I.scale)===1?delete I.scale:I.scale=Number(I.scale),L(I.unitLabel)&&delete I.unitLabel,I.swap_words!==!0&&delete I.swap_words,I}),C.tariffs=Object.assign({},m.tariffs),Zi.forEach(function(P){C.tariffs[P]=Number(m.tariffs[P])}),m.tariffs.co2_g_kwh!==void 0&&m.tariffs.co2_g_kwh!==""&&(C.tariffs.co2_g_kwh=Number(m.tariffs.co2_g_kwh)),["grid_import_ht_chf_kwh","grid_import_nt_chf_kwh"].forEach(function(P){L(m.tariffs[P])?delete C.tariffs[P]:C.tariffs[P]=Number(m.tariffs[P])}),Array.isArray(m.tariffs.ht_windows)&&(m.tariffs.ht_windows.length===0?delete C.tariffs.ht_windows:C.tariffs.ht_windows=m.tariffs.ht_windows.map(function(P){return{days:P.days,from:Number(P.from),to:Number(P.to)}})),C}function R(m){!m||L(m.id)||U.setLoadState(m.id,"INACTIVE").catch(function(){})}function B(m){wi.navigate("/einstellungen/"+Jo[m])}var q=Zo.map(function(m){return u`
        <button key=${m} type="button"
          class=${"pill"+(m===n?" pill-active":"")}
          onClick=${function(){B(m)}}>${s(Qo[m])}</button>`}),K;return l?K=u`
        <${F}>
          <p class="placeholder-text">${s("settings.load_error")}</p>
          <${Y} secondary small onClick=${O}>${s("settings.retry")}<//>
        <//>`:i?n==="site"?K=u`<${$l} cfg=${i} patch=${N} idLocked=${h}
        onSave=${A} saving=${f} />`:n==="tariffs"?K=u`<${Nl} tariffs=${i.tariffs} patch=${k}
        setWindows=${H} onSave=${A} saving=${f} />`:n==="daten"?K=u`<${Pl} />`:n==="gplug"?K=u`<${Tl} />`:n==="pro"?K=u`<${Al} onSaved=${O} />`:n==="loads"?K=u`<${Pt} group="loads"
        ...
        onSave=${A} saving=${f} />`:n==="productions"?K=u`<${Pt} group="production"
        ...
        onSave=${A} saving=${f} />`:n==="grid"?K=u`<${Pt} group="grid" fixedList
        ...
        onSave=${A} saving=${f} />`:n==="modbus"&&(K=u`<${Pt} group="grid"
